...
| External logic-network probes | ABC AIG/XAG/LUT, ROS-style LUT and garbage-budget proxy, mockturtle KLUT-to-XAG, Caterpillar ANF-XAG API, CirKit AIG/MC | The score advantage persists against stronger exported-network, official-header, and local implementation-family API probes. | Does not reproduce full ROS SAT garbage management or reversible/hardware mapping. |
