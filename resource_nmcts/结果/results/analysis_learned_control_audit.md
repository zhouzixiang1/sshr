...
| Bit-flip CV ANF-term prior gate | bounded | 1593 held-out paired rows; 5-fold train-support plus margin gate | retains 328/328 held-out learned score wins; 0 score losses; -1.07% | +31.40% runtime vs no-prior; +8.94% overhead cut vs always-learned | held-out input-feature gate stability; not a new large-scale policy theorem | pass |
| Bit-flip CV gate random-interval control | bounded | 200 same-width random interval assignments | CV gate retains 328/328 learned wins; best random retains 319/328; random mean retains 67.29% | CV overhead cut +8.94%; random intervals may cut more runtime by skipping useful learned rows | bounded specificity control for the CV input-feature gate | pass |
