...
Baseline: `single boolean screen` from `resource_nmcts_experiment/results/raw_giga_highdim_resource.csv` method `and_boolean_linear_pair_screen`.
...
| time_s | 6 | 0 | 6 | 0 | 12.732 | 10.836 | +16.92% |
