    ...
    return [
        ...
        row(
            ...
            [
                ...
                THIS_DIR / "analyze_baseline_fairness_ledger.py",
                THIS_DIR / "analyze_comparison_route_decision_audit.py",
                THIS_DIR / "analyze_benchmark_suite_audit.py",
                THIS_DIR / "analyze_benchmark_function_diversity_audit.py",
                THIS_DIR / "analyze_experimental_evidence_ladder.py",
        ...
        row(
            ...
            [
                ...
                THIS_DIR / "analyze_caterpillar_ros_family_probe.py",
                THIS_DIR / "run_caterpillar_xag_api_probe.py",
        ...
        row(
            ...
            [
                ...
                THIS_DIR / "analyze_cnot_constraint_profile_audit.py",
        ...
        row(
            ...
            [
                ...
                THIS_DIR / "analyze_rotation_synthesis_backend_audit.py",
                THIS_DIR / "analyze_phase_policy_budget_frontier.py",
                THIS_DIR / "analyze_phase_policy_random_control.py",
                THIS_DIR / "analyze_root_action_ranker_audit.py",
                THIS_DIR / "analyze_learned_control_audit.py",
                THIS_DIR / "analyze_stochastic_control_stability.py",
                THIS_DIR / "analyze_neural_mcts_claim_calibration.py",
                THIS_DIR / "train_mcts_budget_policy.py",
                THIS_DIR / "evaluate_mcts_budget_policy.py",
        ...
        row(
            ...
            [
                THIS_DIR / "analyze_runtime_envelope_audit.py",
