...
| Starter-only public-field policy | pass | expected_starter_only=['code_availability.commit_hash', 'code_availability.environment_notes', 'code_availability.repository_url']; observed_starter_only=['code_availability.commit_hash', 'code_availability.environment_notes', 'code_availability.repository_url']; starter_filled=['code_availability.commit_hash', 'code_availability.environment_notes', 'code_availability.repository_url', 'manuscript.title']; starter_unavailable=none; extracted_payload_mode=False. | Keep only repository URL, commit hash, and environment notes delegated to the public starter. |
| Answer-template converter dry-run | pass | filled_paths=4; public_unavailable=none; unknown_answer_paths=none; remaining_author_paths=53. | The public template should dry-run without unknown paths and should still require author/venue input before writing private metadata. |
