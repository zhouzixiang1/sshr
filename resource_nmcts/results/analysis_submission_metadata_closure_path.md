...
| Public answer-template coverage | pass | status_counts={'pass': 5}; required_paths=50; starter_only=['code_availability.commit_hash', 'code_availability.environment_notes', 'code_availability.repository_url']; missing=[]; unknown_answer_paths=[]; needs_revision_count=0. | Keep the public short-answer template aligned with REQUIRED_METADATA_PATHS and the safe public starter fields. |
| Minimal author response-form coverage | pass | status_counts={'pass': 6}; required_paths=50; missing=[]; missing_template_paths=[]; needs_revision_count=0. | Keep AUTHOR_MINIMAL_RESPONSE_FORM_zh.md aligned with REQUIRED_METADATA_PATHS and the structured metadata template. |
| Private metadata starter dry-run | pass | public_prefill_fields=4; unavailable=none; repo_url_shape=True; commit_hash_40hex=True; environment_notes_present=True; manuscript_title_matches=True; author_gated_examples=6. | The starter should prefill safe public repository fields with release-shaped values and leave author/venue declarations human-gated. |
| Private metadata Git protection | pass | private_paths=7; not_ignored=none; tracked=none; metadata_present=False. | Keep submission_metadata.json and generated private previews ignored and untracked. |
...
| Human handoff document coverage | pass | docs=10; missing=none; token_misses=none. | Keep README, checklist, target-venue brief, target-venue policy checklist, handoff, questionnaire, minimal response form, last-mile card, answer template, and author packet aligned with the private metadata workflow. |
| Goal-closure gate consistency | pass | git_worktree=True; metadata_counts={'needs author input': 12}; author_input_closure_counts={'pass': 9}; goal_overall=not complete. | Do not mark the overall goal complete until author/venue metadata are filled and the readiness audit has no unresolved author-input rows. |
