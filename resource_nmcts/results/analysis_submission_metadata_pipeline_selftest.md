...
| preview renderer: author declarations | pass | chars=1965; has_header=True; placeholder_present=False. | Fix renderer output before relying on generated private preview files. |
...
| preview renderer: cover letter | pass | chars=1433; has_header=True; placeholder_present=False. | Fix renderer output before relying on generated private preview files. |
| preview renderer: submission text packet | pass | chars=4392; has_header=True; placeholder_present=False. | Fix renderer output before relying on generated private preview files. |
