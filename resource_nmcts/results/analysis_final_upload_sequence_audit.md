...
| Private preview review path | pass | missing_doc_tokens=none; preview_counts={'needs author input': 1}; private_outputs_are_git_ignored=True; upload_plan_counts={'needs author input': 1}; upload_plan_revisions=0; upload_plan_private_output_ignored=True; upload_plan_tool_counts={'pass': 5}; upload_plan_tool_revisions=0; upload_plan_tool_uses_private_metadata=False. | Review generated private declarations, availability text, cover letter, submission-system text, and route-specific upload plan before upload. |
