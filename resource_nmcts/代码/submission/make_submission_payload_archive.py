...
PAPER = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.pdf"
ANONYMOUS_PAPER = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_anonymous.pdf"
ACM_TQC_PAPER = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_acm_tqc.pdf"
DIST = THIS_DIR / "结果" / "submission_package" / "dist"
...
SELF_OUTPUTS = {
    ...
    RESULTS / "summary_final_upload_sequence_audit.csv",
    RESULTS / "analysis_final_upload_sequence_audit.md",
    RESULTS / "manifest_final_upload_sequence_audit.json",
...
def write_manifest(path: Path, files: list[Path], missing: list[Path], archive_digest: str) -> None:
    data = {
        ...
        "excluded_from_payload": [
            ...
            rel(RESULTS / "summary_final_upload_sequence_audit.csv"),
            rel(RESULTS / "analysis_final_upload_sequence_audit.md"),
            rel(RESULTS / "manifest_final_upload_sequence_audit.json"),
            rel(RESULTS / "summary_upload_bundle_matrix_audit.csv"),
            rel(RESULTS / "analysis_upload_bundle_matrix_audit.md"),
            rel(RESULTS / "manifest_upload_bundle_matrix_audit.json"),
            ...
            rel(RESULTS / "summary_public_handoff_freshness_audit.csv"),
            rel(RESULTS / "analysis_public_handoff_freshness_audit.md"),
            rel(RESULTS / "manifest_public_handoff_freshness_audit.json"),
