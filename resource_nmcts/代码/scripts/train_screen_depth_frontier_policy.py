...
from src.factor_plan import SearchConfig, linear_pair_screen_plan
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    ap.add_argument("--model-out", default=str(THIS_DIR / "模型" / "models" / "boolean_screen_depth_frontier_policy.pt"))
