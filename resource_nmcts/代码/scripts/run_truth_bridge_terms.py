...
from src.anf_utils import boolean_from_anf
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    parser.add_argument("--policy-model", type=Path, default=THIS_DIR / "模型" / "models" / "boolean_screen_depth_policy.pt")
    parser.add_argument("--guard-model", type=Path, default=THIS_DIR / "模型" / "models" / "boolean_screen_depth_guard.pt")
    parser.add_argument(
