...
DEFAULT_MODEL = THIS_DIR / "模型" / "models" / "action_scorer.pt"
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    if args.preset in HIGH_RESOURCE_PRESETS:
        method_rank = {
            ...
            "and_boolean_linear_pair_screen_adaptive": 22,
            "and_boolean_linear_pair_screen_neural": 23,
            "and_boolean_linear_pair_screen_deep_neural": 24,
            "and_boolean_linear_pair_screen_ai_guard": 25,
            "and_boolean_linear_pair_screen_deep_ai_guard": 26,
            "and_fprm_boolean_linear_pair": 27,
            "and_fprm_boolean_linear_pair_deep": 28,
            "and_fprm_boolean_linear_pair_deep_neural": 29,
            "and_fprm_boolean_linear_pair_deep_root_neural": 30,
            "and_fprm_boolean_linear_pair_deep_ai_guard": 31,
            "and_fprm_boolean_linear_pair_screen": 32,
            "and_fprm_boolean_linear_pair_screen_neural": 33,
            "and_fprm_boolean_linear_pair_screen_ai_guard": 34,
            "and_fprm_linear_parity": 35,
            "and_mcts_factor": 36,
            "and_affine_greedy": 37,
            "and_affine_nmcts": 38,
            "and_resource_heuristic": 39,
