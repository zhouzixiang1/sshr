...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    ap.add_argument("--model-out", default=str(THIS_DIR / "模型" / "models" / "boolean_screen_depth_guard.pt"))
    ap.add_argument("--rule-out", default=str(THIS_DIR / "模型" / "models" / "boolean_screen_depth_guard.json"))
