...
PROJECT_ROOT = Path(__file__).resolve().parent.parent  # 代码/ (for sys.path / from src)
PROJ_TOP = PROJECT_ROOT.parent                          # resource_nmcts/ (文本/代码/结果/模型 siblings)
...
RESULTS = PROJ_TOP / "结果" / "results"
TABLES = PROJ_TOP / "文本" / "paper_latex" / "tables"
MODEL = PROJ_TOP / "模型" / "models" / "action_scorer.pt"
