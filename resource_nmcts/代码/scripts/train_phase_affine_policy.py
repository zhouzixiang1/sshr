...
from src.affine_search import candidate_transforms, identity_rows, linear_cnot_sequence, transform_function
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    parser.add_argument("--model-out", type=Path, default=THIS_DIR / "模型" / "models" / "phase_affine_policy_tperrz30.pt")
