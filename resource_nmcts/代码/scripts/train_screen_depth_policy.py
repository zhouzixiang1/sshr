...
from src.factor_plan import SearchConfig, boolean_linear_factor_actions, linear_pair_screen_plan
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    ap.add_argument("--model-out", default=str(THIS_DIR / "模型" / "models" / "boolean_screen_depth_policy.pt"))
    ap.add_argument("--results-dir", default=str(THIS_DIR / "结果" / "results"))
    ap.add_argument("--tables-dir", default=str(THIS_DIR / "文本" / "paper_latex" / "tables"))
