...
AUTHOR_PAPER = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.tex"
ANON_PAPER = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_anonymous.tex"
...
def specs() -> list[TargetSpec]:
    return [
        ...
        TargetSpec(
            ...
            compared_against="ABC AIG/XAG/LUT, ROS-style LUT and garbage-budget proxy, mockturtle KLUT-to-XAG, Caterpillar XAG API, CirKit AIG/MC",
            ...
            required_evidence_tokens=("ROS-style LUT proxy", "mockturtle KLUT-to-XAG probe", "Caterpillar XAG API probe", "CirKit AIG/MC probe"),
            required_comparability_tokens=("ABC/BDD and exported logic networks", "ROS-style LUT and XAG/AIG/API probes"),
        ...
        TargetSpec(
            ...
            role="causal control",
            compared_against="No-MCTS portfolio, beam-only, learned prior off, random prior, random depth, sparse gate, always-on Pareto",
            meaning_test="These controls separate representation/search-space effects from MCTS, neural ranking, guards, and reinforcement-learned Pareto budget allocation.",
            ...
            required_control_tokens=("MCTS over deterministic portfolio", "bit-flip random control", "frontier random-depth control", "reinforcement-learned Pareto budget control"),
            required_artifacts=(
            ...
            supported_statement="Evidence that learned/search controls add bounded quality or planning gains and that fitted-Q control can reduce optional Pareto effort.",
            invalid_statement="Not evidence that deep reinforcement learning alone causes the full resource reduction or dominates always-on Pareto score.",
        ),
        TargetSpec(
