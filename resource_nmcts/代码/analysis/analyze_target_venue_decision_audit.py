...
VENUES = (
    VenueDecision(
        ...
        pre_upload_action="Use ACM's current primary article template in single-column review format, add ACM journal metadata/keywords if required, and keep artifact links ready.",
        policy_gate="Confirm ACM primary-article template version, approved LaTeX packages, article type, references, artifact policy, and any author/AI disclosure requirements.",
        source_url="https://www.acm.org/publications/authors/submissions",
        source_summary="ACM author instructions ask for the current Primary Article Template in single-column manuscript review format and TAPS-compatible LaTeX package discipline; TQC scope remains computational quantum computing and design automation.",
    ),
    VenueDecision(
        venue="Quantum",
        short_name="Quantum",
        ...
        pre_upload_action="Post or cross-list the preprint to quant-ph, sharpen the first-pages contribution summary, and prepare mandatory author-contribution plus AI-use statements.",
        ...
        source_summary="Quantum asks for an arXiv reference posted or cross-listed to quant-ph, clear first-pages results and assumptions, mandatory author contributions, and disclosure of LLM/AI use scope.",
    ),
    VenueDecision(
        ...
        pre_upload_action="Convert to IEEE style, confirm the open-access APC/funding path, and keep the logical-layer software-engineering boundary explicit.",
        policy_gate="Confirm IEEE template, article type, open-access/APC path, reference style, and disclosure requirements.",
        source_url="https://tqe.ieee.org/submission-process/",
        source_summary="TQE describes itself as peer-reviewed, gold open-access, no-page-limit, all-electronic, and in scope for quantum computation, information, software, hardware, devices, and metrology.",
    ),
    VenueDecision(
        ...
        source_summary="TCAD submission instructions require an informative 100--250 word abstract, IEEE-style references, index terms, 4--8 keywords, and CAD algorithm/tool relevance.",
    ),
    VenueDecision(
        ...
        pre_upload_action="Strengthen the broad-impact motivation, choose Paper versus Letter only after checking article-type expectations, and align declarations with IOP requirements.",
        policy_gate="Confirm article type, TeX/LaTeX submission route, peer-review model, author contribution/funding/conflict fields, and supplementary data policy.",
        source_url="https://publishingsupport.iopscience.iop.org/journals/quantum-science-technology/",
        source_summary="QST/IOP guidance accepts common TeX/LaTeX variants and distinguishes Letters, Papers, and Perspectives; original Papers should report a significant advance in the field.",
    ),
)
