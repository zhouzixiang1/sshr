...
TABLES = THIS_DIR / "文本" / "paper_latex" / "tables"
FIGURES = THIS_DIR / "文本" / "paper_latex" / "figures" / "submission_v36"
...
def build_rows() -> list[dict[str, str]]:
    return [
        row(
            ...
            [
                _find("analyze_method_workflow_table.py"),
                _find("analyze_algorithm_contract_table.py"),
                _find("analyze_search_budget_contract.py"),
        ...
        row(
            ...
            [
                _find("analyze_contribution_evidence_map.py"),
        ...
        row(
            ...
            [
                _find("analyze_novelty_comparison_scorecard.py"),
                ...
                THIS_DIR / "结果" / "submission_package" / "reviewer_concern_brief.md",
                THIS_DIR / "结果" / "submission_package" / "editor_screening_brief.md",
            ],
        ...
        row(
            ...
            [
                _find("analyze_baseline_claim_matrix.py"),
                _find("analyze_comparison_evidence_matrix.py"),
                _find("analyze_baseline_comparability_audit.py"),
                _find("analyze_counterpoint_claim_boundary.py"),
                _find("analyze_comparison_target_validity_audit.py"),
                _find("analyze_comparison_answer_scorecard.py"),
                _find("analyze_baseline_fairness_ledger.py"),
                _find("analyze_comparison_route_decision_audit.py"),
                _find("analyze_benchmark_suite_audit.py"),
                _find("analyze_benchmark_function_diversity_audit.py"),
                _find("analyze_experimental_evidence_ladder.py"),
                _find("analyze_sshr_reproduction_scope_audit.py"),
                RESULTS / "analysis_comparison_route_decision_audit.md",
                RESULTS / "manifest_comparison_route_decision_audit.json",
                ...
                RESULTS / "manifest_benchmark_suite_audit.json",
                RESULTS / "analysis_benchmark_function_diversity_audit.md",
                RESULTS / "manifest_benchmark_function_diversity_audit.json",
                ...
                TABLES / "benchmark_suite_audit.tex",
                TABLES / "benchmark_function_diversity_audit.tex",
                TABLES / "experimental_evidence_ladder.tex",
                TABLES / "comparison_target_validity_audit.tex",
                TABLES / "comparison_answer_scorecard.tex",
                TABLES / "baseline_fairness_ledger.tex",
                TABLES / "comparison_route_decision_audit.tex",
                TABLES / "sshr_paper_table_crosswalk.tex",
                TABLES / "sshr_reproduction_scope_audit.tex",
                TABLES / "baseline_comparability_audit.tex",
                TABLES / "counterpoint_claim_boundary.tex",
            ],
            "Experimental Design, benchmark-suite audit, evidence ladder, baseline matrices, target-validity table, comparison route-decision table, comparison answer scorecard, baseline fairness ledger, SSHR reproduction-scope audit, and counterpoint audit",
        ...
        row(
            ...
            [
                _find("analyze_threats_to_validity_audit.py"),
        ...
        row(
            ...
            "Traces ROS-style LUT, published STG, mockturtle, Caterpillar API, CirKit, and RevKit CLI comparison evidence.",
            [
                ...
                _find("analyze_caterpillar_ros_family_probe.py"),
                _find("run_caterpillar_xag_api_probe.py"),
                ...
                TABLES / "caterpillar_ros_family_probe.tex",
                TABLES / "caterpillar_xag_api_probe.tex",
        ...
        row(
            ...
            [
                _find("analyze_multimetric_pareto_tradeoff.py"),
                _find("analyze_weight_robustness.py"),
                _find("analyze_resource_weight_sensitivity_audit.py"),
                _find("analyze_cnot_constraint_profile_audit.py"),
                _find("analyze_schedule_metrics.py"),
                _find("analyze_schedule_proxy_audit.py"),
                ...
                TABLES / "cnot_constraint_profile_audit.tex",
                TABLES / "schedule_proxy_audit.tex",
            ],
            "Results, raw multi-resource dominance, score-weight robustness, resource-weight sensitivity, CNOT constraint profile, and schedule-proxy audit",
        ...
        row(
            ...
            [
                _find("analyze_search_control_baseline_audit.py"),
                _find("analyze_bitflip_random_prior_control.py"),
                _find("analyze_bitflip_neural_budget_sweep.py"),
                _find("analyze_frontier_random_depth_control.py"),
                _find("analyze_phase_rotation_precision_audit.py"),
                _find("analyze_phase_rotation_sequence_smoke_audit.py"),
                _find("analyze_rotation_synthesis_backend_audit.py"),
                _find("analyze_phase_policy_budget_frontier.py"),
                _find("analyze_phase_policy_random_control.py"),
                _find("analyze_root_action_ranker_audit.py"),
                _find("analyze_learned_control_audit.py"),
                _find("analyze_stochastic_control_stability.py"),
                _find("analyze_neural_mcts_claim_calibration.py"),
                _find("train_mcts_budget_policy.py"),
                _find("evaluate_mcts_budget_policy.py"),
                _find("train_sparse_depth4_gate.py"),
                THIS_DIR / "模型" / "models" / "mcts_budget_policy.pt",
                ...
                TABLES / "rotation_synthesis_backend_audit.tex",
                TABLES / "phase_policy_budget_frontier.tex",
                TABLES / "phase_policy_random_control.tex",
            ...
            "Supports guarded learned-control evidence and a held-out fitted-Q search-budget result; RL controls optional Pareto effort rather than explaining all synthesis gains.",
        ),
        row(
            ...
            [
                _find("analyze_scaling_resource_audit.py"),
                _find("analyze_ultra_scale64_stress.py"),
                _find("analyze_ultra_scale64_resource_profile.py"),
        ...
        row(
            ...
            "Consolidates workstation timing evidence for feasibility without promoting portable runtime-speedup claims.",
            [
                _find("analyze_runtime_envelope_audit.py"),
                RESULTS / "summary_runtime_envelope_audit.csv",
                RESULTS / "analysis_runtime_envelope_audit.md",
                RESULTS / "manifest_runtime_envelope_audit.json",
            ...
            "Experimental Design, runtime-envelope audit table",
            "Wall-clock evidence is workstation-context feasibility evidence; portable claims remain logical resources and verification status.",
        ),
        row(
            "Archive package integrity",
            "Hashes stable submission payload groups and records archive boundaries.",
            [
                _find("analyze_submission_archive_manifest.py"),
        ...
        row(
            ...
            [
                _find("analyze_target_venue_decision_audit.py"),
                _find("analyze_submission_support_packet_audit.py"),
                _find("analyze_submission_metadata_closure_path.py"),
                ...
                THIS_DIR / "结果" / "submission_package" / "target_venue_brief.md",
                THIS_DIR / "结果" / "submission_package" / "AUTHOR_INPUT_REQUIRED.md",
                THIS_DIR / "结果" / "submission_package" / "submission_metadata_template.json",
            ],
        ...
        row(
            ...
            [
                _find("analyze_artifact_rerun_registry.py"),
                _find("analyze_reproducibility_audit.py"),
                _find("analyze_submission_readiness_audit.py"),
                _find("analyze_submission_archive_manifest.py"),
                ...
                TABLES / "submission_archive_manifest.tex",
                THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.tex",
                THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.pdf",
            ],
