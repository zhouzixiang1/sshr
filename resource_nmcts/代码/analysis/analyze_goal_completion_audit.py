...
ANONYMOUS_TEX = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_anonymous.tex"
...
PAYLOAD_SHA256 = THIS_DIR / "结果" / "submission_package" / "dist" / "resource_nmcts_submission_payload.tar.gz.sha256"
...
def build_items() -> list[GoalItem]:
    ...
    return [
        ...
        GoalItem(
            ...
            evidence="Comparison evidence, target-validity roles, function-diversity auditing, and the novelty/comparison scorecard cover internal logical baselines, SSHR, ABC/BDD, ROS-style LUT, mockturtle, Caterpillar API, CirKit, RevKit CLI exact-oracle, controls, and phase/Rz probes.",
            evidence_files=(
                RESULTS / "analysis_comparison_evidence_matrix.md",
                RESULTS / "analysis_baseline_comparability_audit.md",
                RESULTS / "analysis_comparison_target_validity_audit.md",
        ...
        GoalItem(
            ...
            evidence="Scaling, function-diversity, and evidence-ladder audits cover n=20,24,28,32,40 plus an n=48,56,64 ultra-scale symbolic stress/resource-profile slice and complete truth-table bridge checks for n=21--30 generated functions.",
            evidence_files=(
                RESULTS / "analysis_scaling_resource_audit.md",
                RESULTS / "analysis_screen_scale_ultra_scale64_stress.md",
                RESULTS / "analysis_screen_scale_ultra_scale64_resource_profile.md",
            ...
            boundary="High-dimensional rows outside generated bridge slices are symbolic checks, not exhaustive truth-table enumeration for all n=31--64 functions.",
        ...
        GoalItem(
            ...
            evidence_files=(
                PAPER,
                PDF,
                THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_acm_tqc.tex",
                THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_acm_tqc.pdf",
        ...
        GoalItem(
            ...
            evidence_files=(
                ...
                THIS_DIR / "结果" / "submission_package" / "author_declarations_template.md",
                THIS_DIR / "结果" / "submission_package" / "cover_letter_template.md",
                THIS_DIR / "结果" / "submission_package" / "submission_checklist.md",
            ),
