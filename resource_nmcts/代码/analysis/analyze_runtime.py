...
METHOD_LABELS = {
    ...
    "and_fprm_linear_pair_deep_ai_guard": "FPRM deep AI guard",
    "and_fprm_linear_parity": "FPRM linear parity",
    ...
    "and_resource_heuristic": "Heuristic-only portfolio",
    "and_resource_beam_only": "Beam-only portfolio",
    "and_resource_no_mcts": "No-MCTS portfolio",
