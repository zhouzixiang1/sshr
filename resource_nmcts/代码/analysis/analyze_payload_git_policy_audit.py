...
ARCHIVE = THIS_DIR / "结果" / "submission_package" / "dist" / "resource_nmcts_submission_payload.tar.gz"
SHA256 = THIS_DIR / "结果" / "submission_package" / "dist" / "resource_nmcts_submission_payload.tar.gz.sha256"
