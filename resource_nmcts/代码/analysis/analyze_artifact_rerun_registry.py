    ...
    return [
        ...
        EvidenceFamily(
            ...
            manifest_patterns=(
                ...
                "manifest_final_upload_sequence_audit.json",
            ),
            summary_patterns=(
                ...
                "summary_final_upload_sequence_audit.csv",
            ),
            analysis_patterns=(
                ...
                "analysis_final_upload_sequence_audit.md",
            ),
        ...
        EvidenceFamily(
            ...
            manifest_patterns=(
                ...
                "manifest_upload_bundle_matrix_audit.json",
            ),
            summary_patterns=(
                ...
                "summary_upload_bundle_matrix_audit.csv",
            ),
            analysis_patterns=(
                ...
                "analysis_upload_bundle_matrix_audit.md",
            ),
        ...
        EvidenceFamily(
            ...
            claim_use="Separates neural/search-control effects from deterministic algebraic construction, guarded portfolio selection, and reinforcement-learned Pareto budget allocation.",
            ...
            raw_patterns=("raw_neural_*.csv", "raw_highdim_neural_*.csv", "raw_bitflip_*.csv", "raw_mcts_budget_policy_*.csv", "raw_*root_action*.csv", "raw_sparse_depth4_gate*.csv", "raw_search_ablation_*.csv"),
            manifest_patterns=("manifest_*neural*.json", "manifest_bitflip_*.json", "manifest_mcts_budget_policy*.json", "manifest_*root_action*.json", "manifest_frontier_random*.json", "manifest_stochastic_control_stability.json", "manifest_search_ablation_*.json", "manifest_learned_control_audit.json", "manifest_limited_learned_control_boundary.json", "manifest_learned_control_effect_uncertainty.json", "manifest_neural_mcts_claim_calibration.json"),
            summary_patterns=("summary_*neural*.csv", "summary_bitflip_*.csv", "summary_mcts_budget_policy*.csv", "summary_*root_action*.csv", "summary_frontier_random*.csv", "summary_phase_policy_random_control.csv", "summary_sparse_depth4_gate*.csv", "summary_stochastic_control_stability.csv", "summary_search_ablation_*.csv", "summary_search_control_baseline_audit.csv", "summary_learned_control_audit.csv", "summary_limited_learned_control_boundary.csv", "summary_learned_control_effect_uncertainty.csv", "summary_neural_mcts_claim_calibration.csv"),
            analysis_patterns=("analysis_*neural*.md", "analysis_bitflip_*.md", "analysis_mcts_budget_policy.md", "analysis_*root_action*.md", "analysis_frontier_random*.md", "analysis_phase_policy_random_control.md", "analysis_sparse_depth4_gate*.md", "analysis_stochastic_control_stability.md", "analysis_search_ablation_*.md", "analysis_search_control_baseline_audit.md", "analysis_learned_control_audit.md", "analysis_limited_learned_control_boundary.md", "analysis_learned_control_effect_uncertainty.md", "analysis_neural_mcts_claim_calibration.md"),
            dependency_boundary="Training can use MPS/GPU when available; learned controls rank, gate, or allocate optional search effort only. The fitted-Q policy has disjoint train/validation/test truth functions.",
        ),
        EvidenceFamily(
