...
PACKAGE_README = THIS_DIR / "结果" / "submission_package" / "README.md"
...
def specs() -> list[ThreatSpec]:
    return [
        ...
        ThreatSpec(
            threat="AI/MCTS/RL attribution",
            risk="The manuscript could overstate deep learning, MCTS, or reinforcement learning as the sole reason for the gains.",
            evidence_files=(
            ...
            required_tokens=("random", "learned", "MCTS", "contextual-bandit", "disjoint", "95% CI"),
            mitigation="Search-control and random-control audits separate the algebraic search space, MCTS, Pareto archives, and learned ranking; the fitted-Q budget controller uses disjoint train/validation/test functions and paired bootstrap intervals.",
            residual_boundary="Reinforcement learning controls optional Pareto-search effort after a verified base result; it is not end-to-end deep RL and does not dominate always-on Pareto search in score.",
            next_action="Keep AI claims tied to same-budget or explicit quality-effort controls, and preserve the disjoint split and Pareto-regret boundary.",
        ),
        ThreatSpec(
