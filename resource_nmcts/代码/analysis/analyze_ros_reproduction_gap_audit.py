...
REFERENCES = THIS_DIR / "文本" / "paper_latex" / "references.bib"
...
def specs() -> list[RosSpec]:
    return [
        ...
        RosSpec(
            ...
            current_coverage="Toolchain readiness records ABC, mockturtle, Caterpillar API, CirKit, RevKit API, and legacy RevKit/CirKit availability and separates them from full ROS.",
            files=(TOOLCHAIN_ANALYSIS, CATERPILLAR_API_ANALYSIS, REPRODUCIBILITY, README),
            tokens=("mockturtle source and the project KLUT-to-XAG adapter are available", "Caterpillar API", "CirKit 3 shell is locally available", "RevKit/CirKit legacy CLI is locally available", "This is still not the full official ROS flow"),
            csv_expectations=(),
            json_expectations=(),
