...
REVIEWER_BRIEF = THIS_DIR / "结果" / "submission_package" / "reviewer_concern_brief.md"
EDITOR_BRIEF = THIS_DIR / "结果" / "submission_package" / "editor_screening_brief.md"
...
def spec_rows() -> list[ProtocolSpec]:
    return [
        ...
        ProtocolSpec(
            ...
            evidence_tokens=("ROS-style LUT proxy", "mockturtle KLUT-to-XAG probe", "Caterpillar XAG API probe", "CirKit AIG/MC probe"),
            comparability_tokens=("ABC/BDD and exported logic networks", "ROS-style LUT and XAG/AIG/API probes"),
            ...
            manuscript_tokens=("ROS-style LUT", "mockturtle", "Caterpillar API", "CirKit", "external or traditional baselines"),
        ...
        ProtocolSpec(
            ...
            manuscript_tokens=("Search contribution decomposition", "Learned-control audit", "deep-RL-only", "contextual-bandit fitted-Q"),
            usable_conclusion="Ablations support bounded search-control, pruning, gating, and reinforcement-learned Pareto budget allocation.",
            excluded_conclusion="They do not show that deep reinforcement learning alone causes the main resource drop or that the budget policy dominates always-on Pareto score.",
        ),
        ProtocolSpec(
