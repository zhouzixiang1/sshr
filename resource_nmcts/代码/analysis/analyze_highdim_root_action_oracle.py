...
from src.neural_policy import NeuralScorer
from src.resource_model import ResourceCost, ResourceWeights
from run_experiments import make_suite
from src.synthesizers import _direct_screened_polarities
...
def main() -> int:
    ...
    parser.add_argument("--model", default=str(THIS_DIR / "模型" / "models" / "linear_action_scorer_highdim.pt"))
