...
ROWS = (
    ...
    ScorecardRow(
        ...
        answer="Yes. The search-control audit separates heuristic, beam, no-MCTS, MCTS, Pareto, learned/random controls, and a held-out fitted-Q Pareto budget policy.",
        artifacts=(
        ...
        manuscript_tokens=("Search-control baseline audit", "random-prior", "random-depth", "deep reinforcement learning alone", "contextual-bandit fitted-Q"),
        support_tokens=("bounded controls", "not as evidence that deep learning alone explains", "quality-effort tradeoff"),
        evidence_latex=r"Tables~\ref{tab:search-control-baseline-audit}, \ref{tab:learned-control-audit}, \ref{tab:mcts-budget-policy}",
        limitation="The fitted-Q controller allocates optional search effort and has explicit regret against always-on Pareto; it is not end-to-end deep RL.",
    ),
    ScorecardRow(
