...
def candidate_paths(token: str) -> list[Path]:
    ...
    if basename.endswith(".tex"):
        ...
        candidates.extend((THIS_DIR / basename, THIS_DIR / "文本" / "paper_latex" / basename))
    elif basename.endswith(".pdf"):
        candidates.extend(
            (
                THIS_DIR / basename,
                THIS_DIR / "文本" / "paper_latex" / basename,
                THIS_DIR / "文本" / "paper_latex" / "figures" / "submission_v36" / basename,
            )
        )
