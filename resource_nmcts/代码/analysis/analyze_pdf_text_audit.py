...
AUTHOR_PDF = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.pdf"
...
REQUIRED_ANCHORS = (
    ...
    AnchorSpec("RL budget-policy quality retention", ("94.90",)),
    AnchorSpec("RL budget-policy time reduction", ("13.13",)),
