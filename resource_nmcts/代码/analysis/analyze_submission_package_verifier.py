...
while THIS_DIR != THIS_DIR.parent and not (THIS_DIR / "文本").is_dir():
    THIS_DIR = THIS_DIR.parent
RESULTS = THIS_DIR / "结果" / "results"
from _paths import find as _find  # noqa: E402
PDF = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.pdf"
LOG = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.log"
AUTHOR_TEX = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_v1.tex"
ANON_TEX = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_anonymous.tex"
ACM_TEX = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_acm_tqc.tex"
ANONYMOUS_PDF = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_anonymous.pdf"
ANONYMOUS_LOG = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_anonymous.log"
PAYLOAD = THIS_DIR / "结果" / "submission_package" / "dist" / "resource_nmcts_submission_payload.tar.gz"
PAYLOAD_SHA = THIS_DIR / "结果" / "submission_package" / "dist" / "resource_nmcts_submission_payload.tar.gz.sha256"
...
ARCHIVE_MANIFEST_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "submission_archive_manifest.tex"
...
COMPARISON_PROTOCOL_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "comparison_protocol_audit.tex"
COMPARISON_TARGET_VALIDITY_MANIFEST = RESULTS / "manifest_comparison_target_validity_audit.json"
COMPARISON_TARGET_VALIDITY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "comparison_target_validity_audit.tex"
COMPARISON_CLAIM_HIERARCHY_MANIFEST = RESULTS / "manifest_comparison_claim_hierarchy.json"
COMPARISON_CLAIM_HIERARCHY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "comparison_claim_hierarchy.tex"
COMPARISON_ANSWER_SCORECARD_MANIFEST = RESULTS / "manifest_comparison_answer_scorecard.json"
COMPARISON_ANSWER_SCORECARD_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "comparison_answer_scorecard.tex"
BASELINE_FAIRNESS_LEDGER_MANIFEST = RESULTS / "manifest_baseline_fairness_ledger.json"
BASELINE_FAIRNESS_LEDGER_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "baseline_fairness_ledger.tex"
COMPARISON_ROUTE_DECISION_MANIFEST = RESULTS / "manifest_comparison_route_decision_audit.json"
COMPARISON_ROUTE_DECISION_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "comparison_route_decision_audit.tex"
BENCHMARK_SUITE_MANIFEST = RESULTS / "manifest_benchmark_suite_audit.json"
BENCHMARK_SUITE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "benchmark_suite_audit.tex"
BENCHMARK_FUNCTION_DIVERSITY_MANIFEST = RESULTS / "manifest_benchmark_function_diversity_audit.json"
BENCHMARK_FUNCTION_DIVERSITY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "benchmark_function_diversity_audit.tex"
EXPERIMENTAL_EVIDENCE_LADDER_MANIFEST = RESULTS / "manifest_experimental_evidence_ladder.json"
EXPERIMENTAL_EVIDENCE_LADDER_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "experimental_evidence_ladder.tex"
WEIGHT_ROBUSTNESS_MANIFEST = RESULTS / "manifest_weight_robustness.json"
WEIGHT_ROBUSTNESS_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "weight_robustness_compact.tex"
RESOURCE_WEIGHT_SENSITIVITY_MANIFEST = RESULTS / "manifest_resource_weight_sensitivity_audit.json"
RESOURCE_WEIGHT_SENSITIVITY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "resource_weight_sensitivity_audit.tex"
CNOT_CONSTRAINT_PROFILE_MANIFEST = RESULTS / "manifest_cnot_constraint_profile_audit.json"
CNOT_CONSTRAINT_PROFILE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "cnot_constraint_profile_audit.tex"
SSHR_REPRODUCTION_MANIFEST = RESULTS / "manifest_sshr_reproduction_scope_audit.json"
SSHR_REPRODUCTION_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "sshr_reproduction_scope_audit.tex"
...
SSHR_TABLE8_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "sshr_table8_candidate_counts.tex"
...
SSHR_CROSSWALK_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "sshr_paper_table_crosswalk.tex"
THREATS_VALIDITY_MANIFEST = RESULTS / "manifest_threats_to_validity_audit.json"
THREATS_VALIDITY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "threats_to_validity_audit.tex"
NOVELTY_SCORECARD_MANIFEST = RESULTS / "manifest_novelty_comparison_scorecard.json"
NOVELTY_SCORECARD_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "novelty_comparison_scorecard.tex"
...
CATERPILLAR_PROBE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "caterpillar_ros_family_probe.tex"
...
CATERPILLAR_API_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "caterpillar_xag_api_probe.tex"
ROS_GARBAGE_MANIFEST = RESULTS / "manifest_ros_lut_garbage_proxy.json"
ROS_GARBAGE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "ros_lut_garbage_proxy.tex"
ROS_GARBAGE_BUDGET_MANIFEST = RESULTS / "manifest_ros_lut_garbage_budget_frontier.json"
ROS_GARBAGE_BUDGET_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "ros_lut_garbage_budget_frontier.tex"
ROS_CHECKPOINT_MANIFEST = RESULTS / "manifest_ros_lut_checkpoint_optimizer.json"
ROS_CHECKPOINT_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "ros_lut_checkpoint_optimizer.tex"
STG_BENCHMARK_MANIFEST = RESULTS / "manifest_stg_published_benchmark.json"
STG_BENCHMARK_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "stg_published_benchmark.tex"
TRADITIONAL_STRUCTURE_MANIFEST = RESULTS / "manifest_traditional_structure_mechanism.json"
TRADITIONAL_STRUCTURE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "traditional_structure_mechanism.tex"
SEARCH_BUDGET_MANIFEST = RESULTS / "manifest_search_budget_contract.json"
SEARCH_BUDGET_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "search_budget_contract.tex"
SCHEDULE_PROXY_MANIFEST = RESULTS / "manifest_schedule_proxy_audit.json"
SCHEDULE_PROXY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "schedule_proxy_audit.tex"
ULTRA_SCALE64_MANIFEST = RESULTS / "manifest_screen_scale_ultra_scale64_stress.json"
ULTRA_SCALE64_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "screen_scale_ultra_scale64_stress.tex"
ULTRA_SCALE64_PROFILE_MANIFEST = RESULTS / "manifest_screen_scale_ultra_scale64_resource_profile.json"
ULTRA_SCALE64_PROFILE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "screen_scale_ultra_scale64_resource_profile.tex"
...
LEARNED_CONTROL_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "learned_control_audit.tex"
...
MCTS_BUDGET_POLICY_MODEL = THIS_DIR / "模型" / "models" / "mcts_budget_policy.pt"
MCTS_BUDGET_POLICY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "mcts_budget_policy.tex"
LIMITED_LEARNED_BOUNDARY_MANIFEST = RESULTS / "manifest_limited_learned_control_boundary.json"
LIMITED_LEARNED_BOUNDARY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "limited_learned_control_boundary.tex"
LEARNED_EFFECT_UNCERTAINTY_MANIFEST = RESULTS / "manifest_learned_control_effect_uncertainty.json"
LEARNED_EFFECT_UNCERTAINTY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "learned_control_effect_uncertainty.tex"
RUNTIME_ENVELOPE_MANIFEST = RESULTS / "manifest_runtime_envelope_audit.json"
RUNTIME_ENVELOPE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "runtime_envelope_audit.tex"
ROOT_ACTION_RANKER_MANIFEST = RESULTS / "manifest_root_action_ranker_audit.json"
ROOT_ACTION_RANKER_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "root_action_ranker_audit.tex"
PHASE_ROTATION_PRECISION_MANIFEST = RESULTS / "manifest_phase_rotation_precision_audit.json"
PHASE_ROTATION_PRECISION_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "phase_rotation_precision_audit.tex"
PHASE_ROTATION_SEQUENCE_MANIFEST = RESULTS / "manifest_phase_rotation_sequence_smoke_audit.json"
PHASE_ROTATION_SEQUENCE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "phase_rotation_sequence_smoke_audit.tex"
ROTATION_SYNTHESIS_BACKEND_MANIFEST = RESULTS / "manifest_rotation_synthesis_backend_audit.json"
ROTATION_SYNTHESIS_BACKEND_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "rotation_synthesis_backend_audit.tex"
PHASE_POLICY_BUDGET_MANIFEST = RESULTS / "manifest_phase_policy_budget_frontier.json"
PHASE_POLICY_BUDGET_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "phase_policy_budget_frontier.tex"
NEURAL_MCTS_CLAIM_MANIFEST = RESULTS / "manifest_neural_mcts_claim_calibration.json"
NEURAL_MCTS_CLAIM_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "neural_mcts_claim_calibration.tex"
BITFLIP_RANDOM_PRIOR_MANIFEST = RESULTS / "manifest_bitflip_random_prior_control.json"
BITFLIP_RANDOM_PRIOR_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "bitflip_random_prior_control.tex"
BITFLIP_NEURAL_BUDGET_MANIFEST = RESULTS / "manifest_bitflip_neural_budget_sweep.json"
BITFLIP_NEURAL_BUDGET_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "bitflip_neural_budget_sweep.tex"
BITFLIP_PRIOR_DIFFICULTY_MANIFEST = RESULTS / "manifest_bitflip_prior_difficulty_slices.json"
BITFLIP_PRIOR_DIFFICULTY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "bitflip_prior_difficulty_slices.tex"
BITFLIP_PRIOR_FEATURE_GATE_MANIFEST = RESULTS / "manifest_bitflip_prior_feature_gate.json"
BITFLIP_PRIOR_FEATURE_GATE_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "bitflip_prior_feature_gate.tex"
BITFLIP_PRIOR_FEATURE_GATE_CV_MANIFEST = RESULTS / "manifest_bitflip_prior_feature_gate_cv.json"
BITFLIP_PRIOR_FEATURE_GATE_CV_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "bitflip_prior_feature_gate_cv.tex"
...
BITFLIP_PRIOR_FEATURE_GATE_CV_RANDOM_TABLE = (
    THIS_DIR / "文本" / "paper_latex" / "tables" / "bitflip_prior_feature_gate_cv_random_control.tex"
)
FRONTIER_RANDOM_DEPTH_MANIFEST = RESULTS / "manifest_frontier_random_depth_control.json"
FRONTIER_RANDOM_DEPTH_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "frontier_random_depth_control.tex"
STOCHASTIC_CONTROL_STABILITY_MANIFEST = RESULTS / "manifest_stochastic_control_stability.json"
STOCHASTIC_CONTROL_STABILITY_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "stochastic_control_stability.tex"
...
TARGET_VENUE_DECISION_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "target_venue_decision_audit.tex"
TARGET_VENUE_POLICY_MANIFEST = RESULTS / "manifest_target_venue_policy_checklist.json"
TARGET_VENUE_POLICY_CHECKLIST = THIS_DIR / "结果" / "submission_package" / "TARGET_VENUE_POLICY_CHECKLIST_zh.md"
TARGET_VENUE_FORMAT_MANIFEST = RESULTS / "manifest_target_venue_format_smoke.json"
TARGET_VENUE_FORMAT_SOURCE = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_acm_tqc.tex"
TARGET_VENUE_FORMAT_PDF = THIS_DIR / "文本" / "paper_latex" / "resource_nmcts_submission_acm_tqc.pdf"
...
ORACLE_RESOURCE_CITATION_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "oracle_resource_citation_audit.tex"
LEARNING_CITATION_MANIFEST = RESULTS / "manifest_learning_citation_verification.json"
LEARNING_CITATION_TABLE = THIS_DIR / "文本" / "paper_latex" / "tables" / "learning_citation_verification.tex"
...
METADATA_ANSWERS_FILE = THIS_DIR / "结果" / "submission_package" / "submission_metadata_answers.json"
METADATA_FILE = THIS_DIR / "结果" / "submission_package" / "submission_metadata.json"
