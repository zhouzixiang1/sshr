...
TARGET_VENUE_BRIEF = THIS_DIR / "结果" / "submission_package" / "target_venue_brief.md"
README = THIS_DIR / "结果" / "submission_package" / "README.md"
CHECKLIST = THIS_DIR / "结果" / "submission_package" / "submission_checklist.md"
...
AUTHOR_PACKET = THIS_DIR / "结果" / "submission_package" / "AUTHOR_INPUT_REQUIRED.md"
...
def specs() -> list[ScreeningSpec]:
    return [
        ...
        ScreeningSpec(
            ...
            tokens=("bounded controls", "deep learning alone", "Search-control baseline audit", "learned-control", "contextual-bandit", "95% CI"),
            manifest_path=SEARCH_CONTROL,
            manifest_key="needs_revision_count",
            expected_value=0,
            supported_decision="The manuscript can claim neural/MCTS search control and a held-out fitted-Q budget result without overclaiming deep RL.",
            boundary="The largest circuit-resource gains remain tied to algebraic actions and guarded/Pareto selection; RL controls optional search effort.",
        ),
        ScreeningSpec(
...
def main() -> int:
    ...
    write_latex(THIS_DIR / "文本" / "paper_latex" / "tables" / "editorial_screening_audit.tex", rows)
