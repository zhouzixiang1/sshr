...
\author{中文论文稿 v22：RevKit Rz 角度审计版}
\date{2026年7月8日}
...
RevKit API 给出新的强外部边界 & RevKit Python \texttt{oracle\_synth} 在 177 个传统函数上全部可运行；在 Rz-phase lower-bound proxy 下，\method{} 相对 RevKit score 为 6/171/0；加入 1/Rz 符号成本后变为 140/37/0。 & 口径不同：RevKit 更接近 phase-rotation oracle；score+1/Rz 只是敏感性分析，不是精确 Clifford+T rotation synthesis 成本。 \\
