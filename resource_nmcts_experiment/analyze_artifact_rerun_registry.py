...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            claim_use="Makes the distinction between ROS-style proxy evidence, Caterpillar source-family probing, and unreproduced full ROS/SAT garbage management machine-checkable.",
            rerun_tier="quick audit",
            scripts=("analyze_caterpillar_ros_family_probe.py", "analyze_ros_reproduction_gap_audit.py"),
            raw_patterns=("raw_ros_lut_proxy_*.csv", "raw_ros_lut_line_sensitivity.csv", "raw_ros_lut_garbage_proxy.csv", "raw_ros_lut_garbage_budget_frontier.csv", "raw_ros_lut_checkpoint_optimizer.csv"),
            manifest_patterns=("manifest_caterpillar_ros_family_probe.json", "manifest_ros_reproduction_gap_audit.json", "manifest_ros_lut_proxy.json", "manifest_ros_lut_line_sensitivity.json", "manifest_ros_lut_garbage_proxy.json", "manifest_ros_lut_garbage_budget_frontier.json", "manifest_ros_lut_checkpoint_optimizer.json"),
            summary_patterns=("summary_caterpillar_ros_family_probe.csv", "summary_ros_reproduction_gap_audit.csv"),
            analysis_patterns=("analysis_caterpillar_ros_family_probe.md", "analysis_ros_reproduction_gap_audit.md"),
            dependency_boundary="Checks scope and evidence boundaries; Caterpillar is source/API/build smoke evidence only, and full official ROS is not reproduced.",
        ),
        EvidenceFamily(
