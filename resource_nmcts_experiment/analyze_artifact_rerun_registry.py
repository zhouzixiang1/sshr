...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            claim_use="Verifies that cover letter, declarations, venue brief, upload checklist, and handoff docs preserve claim boundaries and author-gated metadata.",
            rerun_tier="quick submission-support audit",
            scripts=("analyze_submission_support_packet_audit.py",),
            raw_patterns=(),
            manifest_patterns=("manifest_submission_support_packet_audit.json",),
            summary_patterns=("summary_submission_support_packet_audit.csv",),
            analysis_patterns=("analysis_submission_support_packet_audit.md",),
        ...
        EvidenceFamily(
            family="Method workflow and algorithm contract",
            claim_use="Verifies that the method description is connected to executable stages, source anchors, and semantic/resource guarantees.",
            rerun_tier="quick method audit",
            scripts=("analyze_method_workflow_table.py", "analyze_algorithm_contract_table.py"),
            raw_patterns=(),
            manifest_patterns=("manifest_algorithm_contract.json",),
            summary_patterns=("summary_method_workflow.csv", "summary_algorithm_contract.csv"),
            analysis_patterns=("analysis_method_workflow.md", "analysis_algorithm_contract.md"),
        ...
        EvidenceFamily(
            ...
            raw_patterns=(),
            manifest_patterns=("manifest_comparison_protocol_audit.json",),
            summary_patterns=(
        ...
        EvidenceFamily(
            ...
            claim_use="Makes the distinction between ROS-style proxy evidence and unreproduced full ROS/SAT garbage management machine-checkable.",
            rerun_tier="quick audit",
            scripts=("analyze_ros_reproduction_gap_audit.py",),
            raw_patterns=("raw_ros_lut_proxy_*.csv", "raw_ros_lut_line_sensitivity.csv"),
            manifest_patterns=("manifest_ros_reproduction_gap_audit.json", "manifest_ros_lut_proxy.json", "manifest_ros_lut_line_sensitivity.json"),
            summary_patterns=("summary_ros_reproduction_gap_audit.csv",),
            analysis_patterns=("analysis_ros_reproduction_gap_audit.md",),
            dependency_boundary="Checks scope and evidence boundaries; it deliberately records that full official ROS is not reproduced.",
        ),
        EvidenceFamily(
        ...
        EvidenceFamily(
            ...
            summary_patterns=("summary_*neural*.csv", "summary_sparse_depth4_gate*.csv", "summary_search_ablation_*.csv", "summary_search_control_baseline_audit.csv"),
            analysis_patterns=("analysis_*neural*.md", "analysis_sparse_depth4_gate*.md", "analysis_search_ablation_*.md", "analysis_search_control_baseline_audit.md", "analysis_learned_control_audit.md"),
