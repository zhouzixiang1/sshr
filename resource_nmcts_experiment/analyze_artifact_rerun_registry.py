...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            manifest_patterns=("manifest_*neural*.json", "manifest_bitflip_*.json", "manifest_frontier_random*.json", "manifest_search_ablation_*.json"),
            summary_patterns=("summary_*neural*.csv", "summary_bitflip_*.csv", "summary_frontier_random*.csv", "summary_sparse_depth4_gate*.csv", "summary_search_ablation_*.csv", "summary_search_control_baseline_audit.csv"),
            analysis_patterns=("analysis_*neural*.md", "analysis_bitflip_*.md", "analysis_frontier_random*.md", "analysis_sparse_depth4_gate*.md", "analysis_search_ablation_*.md", "analysis_search_control_baseline_audit.md", "analysis_learned_control_audit.md"),
