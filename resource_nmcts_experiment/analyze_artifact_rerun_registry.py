...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            raw_patterns=("raw_ros_lut_proxy_*.csv", "raw_ros_lut_line_sensitivity.csv", "raw_ros_lut_garbage_proxy.csv", "raw_ros_lut_garbage_budget_frontier.csv", "raw_ros_lut_checkpoint_optimizer.csv"),
            manifest_patterns=("manifest_ros_reproduction_gap_audit.json", "manifest_ros_lut_proxy.json", "manifest_ros_lut_line_sensitivity.json", "manifest_ros_lut_garbage_proxy.json", "manifest_ros_lut_garbage_budget_frontier.json", "manifest_ros_lut_checkpoint_optimizer.json"),
        ...
        EvidenceFamily(
            ...
            claim_use="Connects high-dimensional symbolic plans to complete truth-table simulation on n=21-28 bridge rows.",
