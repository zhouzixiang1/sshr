...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            raw_patterns=(),
            manifest_patterns=("manifest_submission_metadata_closure_path.json", "manifest_metadata_answer_template_coverage.json"),
            summary_patterns=("summary_submission_metadata_closure_path.csv", "summary_metadata_answer_template_coverage.csv"),
            analysis_patterns=("analysis_submission_metadata_closure_path.md", "analysis_metadata_answer_template_coverage.md"),
            dependency_boundary="Does not require private author metadata; verifies the public short-answer template, safe starter-only public fields, and ignored private-output path before author approval.",
        ),
        EvidenceFamily(
