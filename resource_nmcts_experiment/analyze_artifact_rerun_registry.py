...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            claim_use="Summarizes benchmark-family roles, n ranges, instance counts, raw/verified rows, verification routes, and residual representativeness boundaries.",
            rerun_tier="quick benchmark audit",
            scripts=("analyze_benchmark_suite_audit.py",),
            raw_patterns=(
                "raw_traditional_resource.csv",
            ...
            manifest_patterns=("manifest_benchmark_suite_audit.json",),
            summary_patterns=("summary_benchmark_suite_audit.csv",),
            analysis_patterns=("analysis_benchmark_suite_audit.md",),
