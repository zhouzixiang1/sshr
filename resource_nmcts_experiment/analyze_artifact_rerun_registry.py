...
def specs() -> list[EvidenceFamily]:
    return [
        ...
        EvidenceFamily(
            ...
            raw_patterns=("raw_ros_lut_proxy_*.csv", "raw_ros_lut_line_sensitivity.csv", "raw_ros_lut_garbage_proxy.csv"),
            manifest_patterns=("manifest_ros_lut_proxy.json", "manifest_ros_lut_line_sensitivity.json", "manifest_ros_lut_garbage_proxy.json"),
        ...
        EvidenceFamily(
            ...
            raw_patterns=("raw_ros_lut_proxy_*.csv", "raw_ros_lut_line_sensitivity.csv", "raw_ros_lut_garbage_proxy.csv"),
            manifest_patterns=("manifest_ros_reproduction_gap_audit.json", "manifest_ros_lut_proxy.json", "manifest_ros_lut_line_sensitivity.json", "manifest_ros_lut_garbage_proxy.json"),
        ...
        EvidenceFamily(
            ...
            manifest_patterns=("manifest_*neural*.json", "manifest_bitflip_*.json", "manifest_frontier_random*.json", "manifest_search_ablation_*.json", "manifest_learned_control_audit.json", "manifest_neural_mcts_claim_calibration.json"),
            summary_patterns=("summary_*neural*.csv", "summary_bitflip_*.csv", "summary_frontier_random*.csv", "summary_sparse_depth4_gate*.csv", "summary_search_ablation_*.csv", "summary_search_control_baseline_audit.csv", "summary_learned_control_audit.csv", "summary_neural_mcts_claim_calibration.csv"),
            analysis_patterns=("analysis_*neural*.md", "analysis_bitflip_*.md", "analysis_frontier_random*.md", "analysis_sparse_depth4_gate*.md", "analysis_search_ablation_*.md", "analysis_search_control_baseline_audit.md", "analysis_learned_control_audit.md", "analysis_neural_mcts_claim_calibration.md"),
