...
ROWS = (
    ...
    ScorecardRow(
        ...
        answer="Yes. The package includes ROS-style LUT, mockturtle, CirKit, RevKit CLI, ABC/BDD, and RevKit phase/Rz probes.",
        artifacts=(
        ...
        manuscript_tokens=("ROS-style LUT", "mockturtle", "CirKit", "RevKit CLI"),
        support_tokens=("External toolchain probes", "RevKit CLI"),
        evidence_latex=r"Fig.~\ref{fig:baselines}; Tables~\ref{tab:ros-line}, \ref{tab:revkit-cli}",
    ...
    ScorecardRow(
        ...
        answer="Yes. Large n=20,24,28,32,40 symbolic term-set runs and an n=48,56,64 ultra-scale stress slice are paired with n=21--28 complete truth-table bridge slices.",
        artifacts=(
        ...
        manuscript_tokens=("$n=20,24,28,32,40$", "$n=48,56,64$", "$n=21$--$28$", "complete truth-table bridge"),
