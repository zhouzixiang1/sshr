...
- PDF pages=54/54
- readiness=85 pass + 1 needs author input
- payload_files=1211
- artifact_registry=31 families / 161 raw CSV / 80312 raw rows
- source_privacy=0 strict leaks / 57 provenance files / 1168 payload text files
