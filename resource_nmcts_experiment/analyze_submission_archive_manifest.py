...
def specs() -> list[CategorySpec]:
    return [
        ...
        CategorySpec(
            ...
            boundary="Includes cover-letter, declaration, checklist, reviewer-brief, venue-selection, and structured metadata templates; author-specific fields remain manual.",
        ),
    ]
