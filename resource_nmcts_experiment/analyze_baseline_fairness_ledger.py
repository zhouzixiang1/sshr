...
def specs() -> list[LedgerSpec]:
    return [
        ...
        LedgerSpec(
            ...
            verifier_contract="Learned controls are accepted only through guarded rows, random controls, or held-out checks.",
            ...
            supported_claim="MCTS, Pareto selection, and learned controls add bounded quality or budget-control gains.",
            boundary="Do not claim deep reinforcement learning alone causes the full resource reduction.",
            required_artifacts=(
