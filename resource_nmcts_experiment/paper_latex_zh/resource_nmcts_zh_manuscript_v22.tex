...
Pareto-\method{} vs RevKit oracle\_synth & lower-bound score & 177 & 6/171/0 & $+711.60\%$ \\
FPRM polarity archive vs RevKit oracle\_synth & lower-bound score & 177 & 4/173/0 & $+774.83\%$ \\
SSHR-H vs RevKit oracle\_synth & CNOT & 177 & 34/141/2 & $+34.23\%$ \\
\method{} vs RevKit oracle\_synth & T-like count & 177 & 2/171/4 & $+4060.08\%$ \\
\bottomrule
\end{tabular}
\end{table}
...
RevKit API 给出新的强外部边界 & RevKit Python \texttt{oracle\_synth} 在 177 个传统函数上全部可运行；在 Rz-phase lower-bound proxy 下，\method{} 相对 RevKit score 为 6/171/0；171/177 行含非 Clifford $R_z$。 & 口径不同：RevKit 更接近 phase-rotation oracle；本文当前 emitter 是 X/CNOT/\mct{} bit-flip 逻辑，且 RevKit lower bound 尚未包含非 Clifford rotation synthesis 成本。 \\
