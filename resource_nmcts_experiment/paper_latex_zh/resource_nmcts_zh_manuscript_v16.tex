...
\author{中文论文稿 v16：逻辑层 schedule proxy 版}
\date{2026年7月8日}
...
\begin{itemize}
  ...
  \item 在 $n\leq6$ 传统函数、$n=18,20$ 函数级边界、$n=20$ 到 $40$ 项集级 scale、$n=21,22$ 完整 \ttable{} bridge 以及 emitted-circuit schedule proxy 上给出资源、正确性和逻辑层时序证据。
\end{itemize}
