...
def specs() -> list[ThreatSpec]:
    return [
        ...
        ThreatSpec(
            ...
            required_tokens=("Pareto", "schedule", "Weight profiles", "counterpoint"),
            mitigation="Raw dominance, schedule-proxy, weight-robustness, and counterpoint audits expose resource dimensions separately from the weighted score.",
        ...
        ThreatSpec(
            ...
            residual_boundary="Complete truth-table verification is limited to generated bridge slices; n=26--64 rows are not exhaustive truth-table enumerations.",
