...
def specs() -> list[ThreatSpec]:
    return [
        ...
        ThreatSpec(
            ...
            residual_boundary="Complete truth-table verification is limited to generated n=21--26 bridge slices; n=27--64 rows are not exhaustive truth-table enumerations.",
