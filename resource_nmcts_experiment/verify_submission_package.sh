...
if command -v rg >/dev/null 2>&1; then
  rg -n "pass:|needs author input|Payload SHA|registry_raw|unresolved_count|needs_revision_count|synthetic_only|private_outputs_are_git_ignored|file count|archive sha256" \
