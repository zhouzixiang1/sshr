...
def route_specs() -> list[RouteSpec]:
    return [
        ...
        RouteSpec(
            ...
            right_comparator="No-MCTS, beam, learned-prior, random-prior, random-depth, and stochastic controls",
            same_task_level="same search scaffold or same-budget control, not a competing synthesizer family",
            resource_readout="bounded score deltas, W/L/T, seed stability, and runtime/control tradeoffs",
            ...
            use_when_claiming="Neural ranking, MCTS, and guards add bounded gains beyond deterministic construction.",
            do_not_claim="Do not say deep reinforcement learning alone explains the full resource reduction.",
        ),
        RouteSpec(
