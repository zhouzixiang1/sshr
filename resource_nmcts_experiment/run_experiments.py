...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    if args.preset in HIGH_RESOURCE_PRESETS:
        method_rank = {
            ...
            "and_fprm_linear_parity": 19,
            "and_mcts_factor": 20,
            "and_affine_greedy": 21,
            "and_affine_nmcts": 22,
            "and_resource_heuristic": 23,
            "and_resource_beam_only": 24,
            "and_resource_no_mcts": 25,
            "and_resource_nmcts": 26,
            "and_resource_nmcts_wide": 27,
            "and_profile_resource_nmcts": 28,
            "and_pareto_resource_nmcts": 29,
            "and_fprm_polarity_archive": 30,
        }
