...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    if args.preset in {"large_resource", "large_resource_core", "highdim_resource", "search_ablation_highdim", "highdim_neural_prior", "highdim_guard_upgrade", "highdim_scale_resource", "ultra_highdim_resource", "mega_highdim_resource"}:
        method_rank = {
            ...
            "and_fprm_linear_pair_deep_wide": 13,
            "and_fprm_linear_pair_deep_neural": 14,
            "and_fprm_linear_pair_deep_root_neural": 15,
            "and_fprm_linear_parity": 16,
            "and_mcts_factor": 17,
            "and_affine_greedy": 18,
            "and_affine_nmcts": 19,
            "and_resource_heuristic": 20,
            "and_resource_beam_only": 21,
            "and_resource_no_mcts": 22,
            "and_resource_nmcts": 23,
            "and_resource_nmcts_wide": 24,
            "and_profile_resource_nmcts": 25,
            "and_pareto_resource_nmcts": 26,
            "and_fprm_polarity_archive": 27,
        }
