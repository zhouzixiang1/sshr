...
PRESETS = {
    ...
    "highdim_resource": {
        "methods": ["direct_anf", "and_direct_anf", "and_fprm_greedy", "and_fprm_root_beam", "and_fprm_linear_pair", "and_affine_greedy", "and_resource_nmcts", "and_profile_resource_nmcts", "and_pareto_resource_nmcts"],
        "random_truth": [],
        "random_anf": [(14, 64)],
        "structured_limit": 0,
        "workers": 8,
    ...
    "highdim_scale_resource": {
        "methods": ["direct_anf", "and_direct_anf", "and_fprm_greedy", "and_fprm_root_beam", "and_fprm_linear_pair", "and_fprm_linear_pair_deep", "and_fprm_linear_parity", "and_resource_nmcts", "and_profile_resource_nmcts", "and_pareto_resource_nmcts"],
        "random_truth": [],
        "random_anf": [(15, 32)],
        "structured_limit": 0,
        "workers": 6,
    ...
    "ultra_highdim_resource": {
        "methods": ["direct_anf", "and_direct_anf", "and_fprm_root_beam", "and_fprm_linear_pair", "and_fprm_linear_pair_deep", "and_fprm_linear_pair_deep_root_neural", "and_fprm_linear_pair_deep_ai_guard", "and_resource_nmcts", "and_profile_resource_nmcts", "and_pareto_resource_nmcts"],
        "random_truth": [],
        "random_anf": [(16, 24)],
        "structured_limit": 0,
        "workers": 6,
...
def main(argv: Iterable[str] | None = None) -> int:
    ...
    if args.preset in {"large_resource", "large_resource_core", "highdim_resource", "search_ablation_highdim", "highdim_neural_prior", "highdim_guard_upgrade", "highdim_scale_resource", "ultra_highdim_resource", "mega_highdim_resource"}:
        method_rank = {
            ...
            "and_fprm_linear_pair_deep_wide": 15,
            "and_fprm_linear_pair_deep_neural": 16,
            "and_fprm_linear_parity": 17,
            "and_mcts_factor": 18,
            "and_affine_greedy": 19,
            "and_affine_nmcts": 20,
            "and_resource_heuristic": 21,
            "and_resource_beam_only": 22,
            "and_resource_no_mcts": 23,
            "and_resource_nmcts": 24,
            "and_resource_nmcts_wide": 25,
            "and_profile_resource_nmcts": 26,
            "and_pareto_resource_nmcts": 27,
            "and_fprm_polarity_archive": 28,
        }
