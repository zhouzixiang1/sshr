...
| Scaling and correctness bridges | n=20,24,28,32,40 term-set symbolic runs; n=48,56,64 ultra-scale symbolic stress; n=21-30 complete truth-table bridge rows | The emitted logical-layer circuits remain symbolically and bridge-truth-table verified at larger dimensions. | Does not make exhaustive high-dimensional truth-table benchmarking feasible or complete. |
