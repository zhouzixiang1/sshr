...
| External logic-network probes | ABC AIG/XAG/LUT, ROS-style LUT and garbage-budget proxy, mockturtle KLUT-to-XAG, CirKit AIG/MC | The score advantage persists against stronger exported-network and official-header tool probes. | Does not reproduce full ROS SAT garbage management or reversible/hardware mapping. |
...
| Scaling and correctness bridges | n=20,24,28,32,40 term-set symbolic runs; n=48,56,64 ultra-scale symbolic stress; n=21-26 complete truth-table bridge rows | The emitted logical-layer circuits remain symbolically and bridge-truth-table verified at larger dimensions. | Does not make exhaustive high-dimensional truth-table benchmarking feasible or complete. |
