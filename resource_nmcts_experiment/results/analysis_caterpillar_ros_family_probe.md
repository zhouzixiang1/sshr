...
| Standalone baseline executable | pass | not available | candidate_executables=0; examples_cpp=0; experiments_cpp=0 | The audit records why Caterpillar is currently source-family evidence rather than a new performance row. | No standalone Caterpillar/ROS executable baseline is claimed or used in the result tables. |
