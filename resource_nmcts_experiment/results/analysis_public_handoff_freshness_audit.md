...
|---|---|---|---|
| Current audit outputs are readable | pass | missing_files=none; snapshot={'author_pages': 45, 'anonymous_pages': 45, 'readiness_pass': 70, 'readiness_author_input': 1, 'payload_files': 1071, 'registry_families': 27, 'raw_files': 153, 'raw_rows': 77642, 'strict_local_path_leaks': 0, 'payload_text_files': 1028, 'provenance_local_path_files': 55, 'comparison_pass': 8, 'comparison_rows': 8, 'comparison_needs_revision': 0, 'novelty_pass': 6, 'novelty_rows': 6, 'novelty_needs_revision': 0}. | Regenerate the terminal audits before refreshing public handoff docs. |
