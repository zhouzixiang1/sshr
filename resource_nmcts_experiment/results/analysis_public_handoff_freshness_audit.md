...
- `PDF pages=36/35`
- `readiness=58 pass + 1 needs author input`
- `payload_files=986`
...
|---|---|---|---|
| Current audit outputs are readable | pass | missing_files=none; snapshot={'author_pages': 36, 'anonymous_pages': 35, 'readiness_pass': 58, 'readiness_author_input': 1, 'payload_files': 986, 'registry_families': 24, 'raw_files': 146, 'raw_rows': 60036, 'strict_local_path_leaks': 0, 'payload_text_files': 943, 'provenance_local_path_files': 53, 'comparison_rows': 7, 'comparison_needs_revision': 0, 'novelty_rows': 6, 'novelty_needs_revision': 0}. | Regenerate the terminal audits before refreshing public handoff docs. |
