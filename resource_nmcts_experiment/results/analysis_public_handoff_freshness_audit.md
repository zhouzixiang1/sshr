...
|---|---|---|---|
| Current audit outputs are readable | pass | missing_files=none; snapshot={'author_pages': 51, 'anonymous_pages': 51, 'readiness_pass': 83, 'readiness_author_input': 1, 'payload_files': 1191, 'registry_families': 31, 'raw_files': 161, 'raw_rows': 80312, 'strict_local_path_leaks': 0, 'payload_text_files': 1148, 'provenance_local_path_files': 57, 'comparison_pass': 8, 'comparison_rows': 8, 'comparison_needs_revision': 0, 'novelty_pass': 6, 'novelty_rows': 6, 'novelty_needs_revision': 0}. | Regenerate the terminal audits before refreshing public handoff docs. |
