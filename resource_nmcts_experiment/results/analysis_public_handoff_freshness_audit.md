...
|---|---|---|---|
| Current audit outputs are readable | pass | missing_files=none; snapshot={'author_pages': 39, 'anonymous_pages': 39, 'readiness_pass': 63, 'readiness_author_input': 1, 'payload_files': 1008, 'registry_families': 25, 'raw_files': 147, 'raw_rows': 60306, 'strict_local_path_leaks': 0, 'payload_text_files': 965, 'provenance_local_path_files': 53, 'comparison_pass': 8, 'comparison_rows': 8, 'comparison_needs_revision': 0, 'novelty_pass': 6, 'novelty_rows': 6, 'novelty_needs_revision': 0}. | Regenerate the terminal audits before refreshing public handoff docs. |
