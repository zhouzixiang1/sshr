...
|---|---|---|---|
| Current audit outputs are readable | pass | missing_files=none; snapshot={'author_pages': 43, 'anonymous_pages': 43, 'readiness_pass': 68, 'readiness_author_input': 1, 'payload_files': 1059, 'registry_families': 26, 'raw_files': 152, 'raw_rows': 77154, 'strict_local_path_leaks': 0, 'payload_text_files': 1016, 'provenance_local_path_files': 55, 'comparison_pass': 8, 'comparison_rows': 8, 'comparison_needs_revision': 0, 'novelty_pass': 6, 'novelty_rows': 6, 'novelty_needs_revision': 0}. | Regenerate the terminal audits before refreshing public handoff docs. |
