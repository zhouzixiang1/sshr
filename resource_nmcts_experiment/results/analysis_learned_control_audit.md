...
| Frontier random-depth control | held-out/scale/n=23; 8 random-depth repeats | scale 55/3/38, -1.12%; n23 5/0/1, -0.89%; seed means beaten 8/8 | +58.78% scale planning time vs random-depth mean | quality-oriented budget allocation; not runtime claim |
...
| Bit-flip learned prior | 177 n<=6 functions; 8 random-prior repeats | vs random mean 17/8/152, -0.15%; seed means beaten 8/8 | +48.05% runtime vs random-prior mean | limited quality signal, not runtime claim |
