...
| Artifact coverage | 89 top-level run/train/analyze scripts; 144 raw CSVs; 201 summaries; 100 manifests; 161 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
