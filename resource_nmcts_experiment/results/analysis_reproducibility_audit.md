...
| Artifact coverage | 116 top-level run/train/analyze scripts; 156 raw CSVs; 233 summaries; 129 manifests; 187 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
