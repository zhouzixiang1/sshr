...
| Artifact coverage | 67 top-level run/train/analyze scripts; 144 raw CSVs; 179 summaries; 79 manifests; 152 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
