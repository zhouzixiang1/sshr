...
| Artifact coverage | 113 top-level run/train/analyze scripts; 151 raw CSVs; 227 summaries; 125 manifests; 181 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
