...
| Artifact coverage | 105 top-level run/train/analyze scripts; 147 raw CSVs; 219 summaries; 117 manifests; 174 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
