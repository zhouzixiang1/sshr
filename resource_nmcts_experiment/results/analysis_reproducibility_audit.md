...
| Artifact coverage | 109 top-level run/train/analyze scripts; 149 raw CSVs; 223 summaries; 121 manifests; 177 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
