...
| Artifact coverage | 121 top-level run/train/analyze scripts; 160 raw CSVs; 240 summaries; 134 manifests; 193 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
