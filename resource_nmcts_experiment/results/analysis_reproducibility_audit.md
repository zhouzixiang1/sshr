...
| Artifact coverage | 116 top-level run/train/analyze scripts; 153 raw CSVs; 230 summaries; 129 manifests; 184 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
