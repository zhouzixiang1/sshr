...
| Artifact coverage | 118 top-level run/train/analyze scripts; 158 raw CSVs; 237 summaries; 131 manifests; 190 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
