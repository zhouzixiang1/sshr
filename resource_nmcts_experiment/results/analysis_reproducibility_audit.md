...
| Artifact coverage | 83 top-level run/train/analyze scripts; 144 raw CSVs; 195 summaries; 94 manifests; 155 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
