...
| Artifact coverage | 58 top-level run/train/analyze scripts; 144 raw CSVs; 166 summaries; 65 manifests; 149 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
