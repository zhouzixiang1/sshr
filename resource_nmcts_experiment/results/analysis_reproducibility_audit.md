...
| Artifact coverage | 111 top-level run/train/analyze scripts; 149 raw CSVs; 225 summaries; 123 manifests; 179 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
