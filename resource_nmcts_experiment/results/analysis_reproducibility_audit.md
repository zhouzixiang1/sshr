...
| Artifact coverage | 75 top-level run/train/analyze scripts; 144 raw CSVs; 187 summaries; 86 manifests; 154 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
