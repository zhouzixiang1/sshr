...
| Artifact coverage | 140 top-level run/train/analyze scripts; 161 raw CSVs; 260 summaries; 154 manifests; 204 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
