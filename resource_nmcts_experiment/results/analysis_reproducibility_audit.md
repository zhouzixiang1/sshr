...
| Artifact coverage | 110 top-level run/train/analyze scripts; 149 raw CSVs; 224 summaries; 122 manifests; 178 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
