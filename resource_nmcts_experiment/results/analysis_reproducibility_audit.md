...
| Artifact coverage | 84 top-level run/train/analyze scripts; 144 raw CSVs; 196 summaries; 95 manifests; 155 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
