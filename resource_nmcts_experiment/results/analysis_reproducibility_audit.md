...
| Artifact coverage | 102 top-level run/train/analyze scripts; 146 raw CSVs; 216 summaries; 113 manifests; 171 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
