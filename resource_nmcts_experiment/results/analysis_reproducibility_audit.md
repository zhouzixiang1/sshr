...
| Artifact coverage | 138 top-level run/train/analyze scripts; 161 raw CSVs; 258 summaries; 152 manifests; 202 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
