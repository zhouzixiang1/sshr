...
| Artifact coverage | 114 top-level run/train/analyze scripts; 152 raw CSVs; 228 summaries; 127 manifests; 182 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
