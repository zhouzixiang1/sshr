...
| Artifact coverage | 116 top-level run/train/analyze scripts; 158 raw CSVs; 235 summaries; 129 manifests; 189 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
