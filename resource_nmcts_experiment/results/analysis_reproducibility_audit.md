...
| Artifact coverage | 72 top-level run/train/analyze scripts; 144 raw CSVs; 184 summaries; 83 manifests; 154 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
