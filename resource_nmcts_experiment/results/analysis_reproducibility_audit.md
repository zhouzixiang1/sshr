...
| Artifact coverage | 87 top-level run/train/analyze scripts; 144 raw CSVs; 199 summaries; 98 manifests; 159 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
