...
| Artifact coverage | 100 top-level run/train/analyze scripts; 146 raw CSVs; 214 summaries; 111 manifests; 170 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
