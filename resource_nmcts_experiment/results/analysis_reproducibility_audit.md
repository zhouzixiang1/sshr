...
| Artifact coverage | 57 top-level run/train/analyze scripts; 144 raw CSVs; 164 summaries; 65 manifests; 148 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
