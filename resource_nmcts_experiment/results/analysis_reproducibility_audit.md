...
| Artifact coverage | 145 top-level run/train/analyze scripts; 162 raw CSVs; 266 summaries; 160 manifests; 210 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
