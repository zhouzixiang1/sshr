...
| Artifact coverage | 66 top-level run/train/analyze scripts; 144 raw CSVs; 178 summaries; 78 manifests; 152 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
