...
| Artifact coverage | 142 top-level run/train/analyze scripts; 161 raw CSVs; 262 summaries; 156 manifests; 206 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
