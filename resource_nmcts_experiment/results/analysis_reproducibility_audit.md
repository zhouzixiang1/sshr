...
| Artifact coverage | 126 top-level run/train/analyze scripts; 161 raw CSVs; 245 summaries; 139 manifests; 197 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
