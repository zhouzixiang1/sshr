...
| Artifact coverage | 130 top-level run/train/analyze scripts; 161 raw CSVs; 249 summaries; 143 manifests; 198 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
