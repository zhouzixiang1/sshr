...
| Artifact coverage | 92 top-level run/train/analyze scripts; 145 raw CSVs; 204 summaries; 103 manifests; 163 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
