...
| Artifact coverage | 144 top-level run/train/analyze scripts; 161 raw CSVs; 264 summaries; 158 manifests; 208 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
