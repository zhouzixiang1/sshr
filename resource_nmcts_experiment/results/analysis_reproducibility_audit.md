...
| Artifact coverage | 101 top-level run/train/analyze scripts; 146 raw CSVs; 215 summaries; 112 manifests; 170 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
