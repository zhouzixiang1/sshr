...
| Artifact coverage | 106 top-level run/train/analyze scripts; 148 raw CSVs; 220 summaries; 118 manifests; 175 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
