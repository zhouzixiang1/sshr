...
| Artifact coverage | 61 top-level run/train/analyze scripts; 144 raw CSVs; 170 summaries; 69 manifests; 151 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
