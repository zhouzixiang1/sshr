...
| Artifact coverage | 122 top-level run/train/analyze scripts; 161 raw CSVs; 241 summaries; 135 manifests; 194 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
