...
| Artifact coverage | 68 top-level run/train/analyze scripts; 144 raw CSVs; 180 summaries; 80 manifests; 153 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
