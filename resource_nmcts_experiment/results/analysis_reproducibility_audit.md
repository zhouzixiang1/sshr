...
| Artifact coverage | 99 top-level run/train/analyze scripts; 146 raw CSVs; 212 summaries; 110 manifests; 169 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
