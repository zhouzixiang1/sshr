...
| Artifact coverage | 139 top-level run/train/analyze scripts; 161 raw CSVs; 259 summaries; 153 manifests; 203 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
