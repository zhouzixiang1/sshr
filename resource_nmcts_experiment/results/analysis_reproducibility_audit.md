...
| Artifact coverage | 59 top-level run/train/analyze scripts; 144 raw CSVs; 167 summaries; 66 manifests; 150 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
