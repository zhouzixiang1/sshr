...
| Artifact coverage | 124 top-level run/train/analyze scripts; 161 raw CSVs; 243 summaries; 137 manifests; 196 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
