...
| Artifact coverage | 103 top-level run/train/analyze scripts; 146 raw CSVs; 217 summaries; 115 manifests; 172 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
