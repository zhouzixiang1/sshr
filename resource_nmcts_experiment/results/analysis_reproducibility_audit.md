...
| Artifact coverage | 137 top-level run/train/analyze scripts; 161 raw CSVs; 257 summaries; 151 manifests; 201 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
