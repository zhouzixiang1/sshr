...
| Artifact coverage | 141 top-level run/train/analyze scripts; 161 raw CSVs; 261 summaries; 155 manifests; 205 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
