...
| Artifact coverage | 135 top-level run/train/analyze scripts; 161 raw CSVs; 254 summaries; 148 manifests; 200 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
