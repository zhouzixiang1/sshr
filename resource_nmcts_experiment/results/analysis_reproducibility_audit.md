...
| Artifact coverage | 70 top-level run/train/analyze scripts; 144 raw CSVs; 182 summaries; 81 manifests; 154 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
