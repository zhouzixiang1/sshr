...
| Artifact coverage | 146 top-level run/train/analyze scripts; 162 raw CSVs; 268 summaries; 162 manifests; 212 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
