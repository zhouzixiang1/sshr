...
| Artifact coverage | 85 top-level run/train/analyze scripts; 144 raw CSVs; 197 summaries; 96 manifests; 156 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
