...
| Artifact coverage | 97 top-level run/train/analyze scripts; 145 raw CSVs; 209 summaries; 108 manifests; 167 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
