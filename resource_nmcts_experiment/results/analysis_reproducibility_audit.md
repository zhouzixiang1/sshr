...
| Artifact coverage | 79 top-level run/train/analyze scripts; 144 raw CSVs; 191 summaries; 90 manifests; 154 paper tables; 7 figure panels (21 PDF/PNG/SVG assets) | Counts describe the current artifact package, not independent datasets. |
