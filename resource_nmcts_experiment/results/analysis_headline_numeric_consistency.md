...
|---|---|---|---|---|---|
| n<=6 Pareto vs direct ANF mean T-count reduction | pass | pairs=177; mean=-73.92% | pairs=177; mean=-73.92% | `results/raw_traditional_resource.csv` | 73.92% |
...
| headline verification row count | pass | verified_total=15,762; bridge_400_400=True | verified_total=15,762; bridge_400_400=True | `results/summary_comparison_evidence_matrix.csv` | 15,762; 400/400 |
