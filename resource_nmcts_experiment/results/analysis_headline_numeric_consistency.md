...
| sparse depth-2/4 frontier bridge time reduction | pass | bridge_rows=4; time_range=24.94%--28.88%; score_tied=True | bridge_rows=4; time_range=24.94%--28.88%; score_tied=True | `results/summary_sparse_depth_frontier.csv` | 24.94--28.88% |
...
| headline verification row count | pass | verified_total=15,774; bridge_460_460=True; all_exact=True | verified_total=15,774; bridge_460_460=True; all_exact=True | `paper_latex/figures/submission_v36/source_data/fig5_validation.csv` | 15,774; 460/460 |
