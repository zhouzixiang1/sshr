...
| sparse depth-2/4 frontier bridge time reduction | pass | bridge_rows=6; time_range=24.94%--29.23%; score_tied=True | bridge_rows=6; time_range=24.94%--29.23%; score_tied=True | `results/summary_sparse_depth_frontier.csv` | 24.94--29.23% |
...
| headline verification row count | pass | verified_total=15,774; bridge_580_580=True; all_exact=True | verified_total=15,774; bridge_580_580=True; all_exact=True | `paper_latex/figures/submission_v36/source_data/fig5_validation.csv` | 15,774; 580/580 |
