...
|---|---|---|---:|---:|---|---|
| Payload extraction for verifier smoke | pass | `submission_package/dist/resource_nmcts_submission_payload.tar.gz` | n/a | 0.000 | extracted_files=905; error=none. | Regenerate the payload archive if it cannot be safely extracted. |
