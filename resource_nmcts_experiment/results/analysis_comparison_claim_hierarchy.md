...
|---|---|---|---|---|---|
| Headline support | Primary matched logical-oracle evidence | Direct ANF, AND-direct, ESOP beam/MILP, ABC-ESOP/BDD same-task projections | Lower T-count and weighted score on matched logical bit-flip Boolean-oracle benchmarks. | No universal CNOT, depth, ancilla, line-count, hardware-mapped, or global-optimality claim. | pass |
...
| Search-control attribution | Causal and ablation evidence for AI/search components | No-MCTS, beam-only, learned/no-prior, random-prior, random-depth, sparse/guard, fitted-Q Pareto-budget controls | Neural/MCTS controls provide bounded quality, pruning, or budget-allocation gains; fitted-Q control reduces optional Pareto effort at explicit score regret. | The paper does not claim that deep reinforcement learning alone causes the full resource reduction or that fitted-Q dominates always-on Pareto score. | pass |
