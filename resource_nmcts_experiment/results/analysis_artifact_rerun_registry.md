...
| Submission metadata closure path | quick metadata audit | 0 | 0 | 2 | complete | Does not require private author metadata; verifies the public short-answer template, safe starter-only public fields, and ignored private-output path before author approval. |
...
- **Submission metadata closure path**
  ...
  - scripts: `analyze_submission_metadata_closure_path.py; analyze_metadata_answer_template_coverage.py; make_submission_metadata_from_answers.py; make_submission_metadata_starter.py; validate_submission_metadata.py; make_submission_text_preview.py`
  - representative raw: not applicable for this tier
