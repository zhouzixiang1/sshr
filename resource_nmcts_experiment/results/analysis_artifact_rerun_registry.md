...
| Learned-control and ablations | training plus ablation rerun | 20 | 10883 | 20 | complete | Training can use MPS/GPU when available; learned controls rank, gate, or allocate search only. |
