...
| Private metadata starter dry-run | pass | public_prefill_fields=2; unavailable=none; repo_url_shape=True; commit_hash_40hex=True; environment_notes_present=True; author_gated_examples=6. | The starter should prefill safe public repository fields with release-shaped values and leave author/venue declarations human-gated. |
