...
| Learned-control runtime boundary | compressed bit-flip budgets plus promoted learned controls | 708/708 | median=2.12s; p95=6.41s; max=7.72s | Learned controls are quality/budget evidence with explicit overhead or savings, not a blanket speedup claim. | pass |
