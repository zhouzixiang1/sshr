...
|---|---|---|---|
| Compiled author PDF | pass | paper_latex/resource_nmcts_submission_v1.pdf pages=32, bytes=618916. | Rebuild the submission package and inspect latexmk output if the PDF is missing. |
| Compiled anonymous PDF | pass | paper_latex/resource_nmcts_submission_anonymous.pdf pages=32, bytes=615556. | Rebuild the submission package and inspect latexmk output if the PDF is missing. |
| Payload SHA sidecar | pass | actual=49bf61d3ce0b81b9de7913b6efb2f5bfeac9de18c1b5ee17964a1437edeea8f5; sidecar=49bf61d3ce0b81b9de7913b6efb2f5bfeac9de18c1b5ee17964a1437edeea8f5. | Regenerate the payload archive if the digests differ. |
| Payload manifest consistency | pass | summary=49bf61d3ce0b81b9de7913b6efb2f5bfeac9de18c1b5ee17964a1437edeea8f5; manifest=49bf61d3ce0b81b9de7913b6efb2f5bfeac9de18c1b5ee17964a1437edeea8f5; file_count=942. | Regenerate make_submission_payload_archive.py outputs if summary and manifest disagree. |
| Readiness audit terminal state | pass | status_counts={'pass': 49, 'needs author input': 1}; terminal_verifier_self_row_excluded=True. | Resolve any needs-revision rows; author-specific declarations remain manual. |
| Artifact rerun registry coverage | pass | families=21; registry_raw=145; actual_raw=145. | Rerun analyze_artifact_rerun_registry.py after adding raw CSVs or driver scripts. |
...
| Search-control baseline audit | pass | rows=9; needs_revision_count=0; status_counts={'pass': 9}. | Run analyze_search_control_baseline_audit.py and restore heuristic, beam, no-MCTS, MCTS, Pareto, learned-prior, bit-flip random-prior, and phase random-control evidence rows. |
...
| LaTeX dependency audit | pass | dependencies=92; type_counts={'bibliography': 2, 'figure': 14, 'main_source': 2, 'tex_input': 74}; needs_revision_count=0; status_counts={'pass': 92}. | Run analyze_latex_dependency_audit.py after payload creation and restore missing TeX, table, figure, bibliography, or payload entries. |
...
| Payload round-trip audit | pass | needs_revision_count=0; status_counts={'pass': 21}. | Run analyze_payload_roundtrip_audit.py after payload creation and fix any archive/manifest/path/hash issues. |
| Payload extraction smoke audit | pass | needs_revision_count=0; status_counts={'pass': 19}; smoke_scripts=18. | Run analyze_payload_extraction_smoke_audit.py after payload creation and fix extracted-payload script failures. |
