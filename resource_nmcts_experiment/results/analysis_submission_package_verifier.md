...
| Payload SHA sidecar | pass | actual=4f886da4add847e34557db37d739780b8dabfe5c7d170ebcc67ced1675429488; sidecar=4f886da4add847e34557db37d739780b8dabfe5c7d170ebcc67ced1675429488. | Regenerate the payload archive if the digests differ. |
| Payload manifest consistency | pass | summary=4f886da4add847e34557db37d739780b8dabfe5c7d170ebcc67ced1675429488; manifest=4f886da4add847e34557db37d739780b8dabfe5c7d170ebcc67ced1675429488; file_count=874. | Regenerate make_submission_payload_archive.py outputs if summary and manifest disagree. |
| Readiness audit terminal state | pass | status_counts={'pass': 36, 'needs author input': 1}. | Resolve any needs-revision rows; author-specific declarations remain manual. |
...
| Payload extraction smoke audit | pass | needs_revision_count=0; status_counts={'pass': 8}; smoke_scripts=7. | Run analyze_payload_extraction_smoke_audit.py after payload creation and fix extracted-payload script failures. |
