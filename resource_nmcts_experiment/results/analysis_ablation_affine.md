# Ablation_Affine Analysis

Rows: 2254; usable: 2108; errors: 1; skipped: 145.
...
|---|---:|---:|---:|---:|
| and_affine_greedy | 322 | -60.92% | -88.89% | +0.00% |
| and_affine_nmcts | 322 | -61.83% | -88.89% | +0.00% |
| and_affine_no_guard | 322 | -61.19% | -88.89% | +0.00% |
...
|---|---:|---:|---:|
| and_affine_greedy | 171 | 6 | -42.73% |
| and_affine_nmcts | 171 | 6 | -43.89% |
| and_affine_no_guard | 171 | 6 | -43.77% |
...
|---|---|---|---:|---:|---:|---:|
| and_affine_nmcts | and_affine_greedy | T | 102 | 0 | 220 | -2.81% |
| and_affine_nmcts | and_affine_greedy | CNOT | 121 | 26 | 175 | -1.82% |
| and_affine_nmcts | and_affine_greedy | depth | 125 | 25 | 172 | -1.89% |
| and_affine_nmcts | and_affine_greedy | peak_ancilla | 33 | 0 | 289 | -3.29% |
| and_affine_nmcts | and_affine_greedy | score | 153 | 0 | 169 | -2.82% |
| and_affine_nmcts | and_affine_no_guard | T | 77 | 0 | 245 | -1.81% |
| and_affine_nmcts | and_affine_no_guard | CNOT | 77 | 10 | 235 | -0.87% |
| and_affine_nmcts | and_affine_no_guard | depth | 78 | 10 | 234 | -0.89% |
| and_affine_nmcts | and_affine_no_guard | peak_ancilla | 15 | 0 | 307 | -1.42% |
| and_affine_nmcts | and_affine_no_guard | score | 88 | 0 | 234 | -1.74% |
...
| and_affine_no_guard | and_affine_greedy | T | 25 | 0 | 297 | -1.00% |
| and_affine_no_guard | and_affine_greedy | CNOT | 44 | 16 | 262 | -0.95% |
| and_affine_no_guard | and_affine_greedy | depth | 47 | 15 | 260 | -1.01% |
| and_affine_no_guard | and_affine_greedy | peak_ancilla | 18 | 0 | 304 | -1.86% |
| and_affine_no_guard | and_affine_greedy | score | 65 | 0 | 257 | -1.08% |
| and_affine_no_guard | and_mcts_factor | T | 161 | 77 | 83 | -14.18% |
| and_affine_no_guard | and_mcts_factor | CNOT | 174 | 78 | 69 | -13.94% |
| and_affine_no_guard | and_mcts_factor | depth | 171 | 81 | 69 | -11.58% |
| and_affine_no_guard | and_mcts_factor | peak_ancilla | 1 | 28 | 292 | +3.80% |
| and_affine_no_guard | and_mcts_factor | score | 165 | 88 | 68 | -12.91% |
| and_affine_greedy | and_mcts_factor | T | 161 | 77 | 83 | -13.49% |
| and_affine_greedy | and_mcts_factor | CNOT | 174 | 77 | 70 | -13.22% |
| and_affine_greedy | and_mcts_factor | depth | 165 | 86 | 70 | -10.77% |
| and_affine_greedy | and_mcts_factor | peak_ancilla | 1 | 46 | 274 | +6.60% |
| and_affine_greedy | and_mcts_factor | score | 165 | 88 | 68 | -12.12% |
...
## Largest and-affine-no-guard gains vs direct ANF

| function | n | direct T | and_affine_no_guard T | relative |
|---|---:|---:|---:|---:|
| truth_n4_48 | 4 | 108 | 12 | -88.89% |
| majority_n5 | 5 | 280 | 32 | -88.57% |
| truth_n5_44 | 5 | 228 | 28 | -87.72% |
...
## and_affine_no_guard vs SSHR-H

| function | n | SSHR-H T | and_affine_no_guard T | relative | peak ancilla |
|---|---:|---:|---:|---:|---:|
| parity_n3 | 3 | 8 | 0 | -100.00% | 0 |
| parity_n4 | 4 | 8 | 0 | -100.00% | 0 |
| parity_n5 | 5 | 96 | 0 | -100.00% | 0 |
...
| truth_n4_1 | 4 | 20 | 20 | +0.00% | 1 |
| truth_n4_9 | 4 | 20 | 20 | +0.00% | 1 |
| adder_carry_w3 | 6 | 48 | 52 | +8.33% | 2 |
| truth_n5_58 | 5 | 24 | 28 | +16.67% | 1 |

## and_affine_greedy vs SSHR-H

| function | n | SSHR-H T | and_affine_greedy T | relative | peak ancilla |
|---|---:|---:|---:|---:|---:|
| parity_n3 | 3 | 8 | 0 | -100.00% | 0 |
| parity_n4 | 4 | 8 | 0 | -100.00% | 0 |
| parity_n5 | 5 | 96 | 0 | -100.00% | 0 |
...
| truth_n4_34 | 4 | 44 | 12 | -72.73% | 2 |
| truth_n4_49 | 4 | 28 | 8 | -71.43% | 1 |
| truth_n5_25 | 5 | 112 | 36 | -67.86% | 2 |
| truth_n5_5 | 5 | 124 | 40 | -67.74% | 2 |
| truth_n4_22 | 4 | 48 | 16 | -66.67% | 2 |
| truth_n5_37 | 5 | 56 | 20 | -64.29% | 1 |
| truth_n5_38 | 5 | 100 | 36 | -64.00% | 3 |
| truth_n4_18 | 4 | 44 | 16 | -63.64% | 2 |
| truth_n5_21 | 5 | 88 | 32 | -63.64% | 2 |
| truth_n5_22 | 5 | 108 | 40 | -62.96% | 3 |
| truth_n5_62 | 5 | 96 | 36 | -62.50% | 2 |
| truth_n5_40 | 5 | 92 | 36 | -60.87% | 3 |
| majority_n5 | 5 | 80 | 32 | -60.00% | 2 |
| mul_w3_bit2 | 6 | 48 | 20 | -58.33% | 2 |
| truth_n5_1 | 5 | 96 | 40 | -58.33% | 3 |
| truth_n5_13 | 5 | 76 | 32 | -57.89% | 2 |
| truth_n5_53 | 5 | 104 | 44 | -57.69% | 3 |
| truth_n4_10 | 4 | 28 | 12 | -57.14% | 2 |
| truth_n4_41 | 4 | 28 | 12 | -57.14% | 2 |
| truth_n4_48 | 4 | 28 | 12 | -57.14% | 2 |
| truth_n5_41 | 5 | 84 | 36 | -57.14% | 2 |
...
| truth_n5_17 | 5 | 80 | 36 | -55.00% | 2 |
| truth_n4_13 | 4 | 44 | 20 | -54.55% | 2 |
| truth_n4_14 | 4 | 44 | 20 | -54.55% | 2 |
| truth_n4_46 | 4 | 44 | 20 | -54.55% | 2 |
| truth_n4_54 | 4 | 44 | 20 | -54.55% | 2 |
| truth_n4_59 | 4 | 44 | 20 | -54.55% | 2 |
| truth_n5_32 | 5 | 88 | 40 | -54.55% | 2 |
| truth_n5_7 | 5 | 88 | 40 | -54.55% | 2 |
| truth_n5_48 | 5 | 104 | 48 | -53.85% | 3 |
| truth_n5_19 | 5 | 84 | 40 | -52.38% | 2 |
...
| truth_n5_30 | 5 | 60 | 32 | -46.67% | 2 |
| truth_n6_10 | 6 | 240 | 128 | -46.67% | 3 |
| truth_n5_2 | 5 | 104 | 56 | -46.15% | 3 |
| truth_n5_50 | 5 | 96 | 52 | -45.83% | 3 |
| majority_n4 | 4 | 44 | 24 | -45.45% | 2 |
| truth_n5_33 | 5 | 88 | 48 | -45.45% | 3 |
| truth_n5_46 | 5 | 88 | 48 | -45.45% | 3 |
| truth_n5_8 | 5 | 88 | 48 | -45.45% | 3 |
| truth_n5_20 | 5 | 80 | 44 | -45.00% | 2 |
| truth_n4_60 | 4 | 36 | 20 | -44.44% | 2 |
...
| truth_n5_31 | 5 | 64 | 40 | -37.50% | 2 |
| truth_n5_6 | 5 | 64 | 40 | -37.50% | 2 |
| truth_n5_56 | 5 | 76 | 48 | -36.84% | 3 |
| truth_n6_11 | 6 | 232 | 148 | -36.21% | 3 |
| truth_n6_28 | 6 | 156 | 100 | -35.90% | 2 |
| truth_n6_24 | 6 | 228 | 148 | -35.09% | 3 |
| truth_n5_3 | 5 | 80 | 52 | -35.00% | 2 |
| truth_n5_63 | 5 | 80 | 52 | -35.00% | 3 |
| truth_n6_12 | 6 | 184 | 120 | -34.78% | 2 |
| truth_n6_16 | 6 | 196 | 128 | -34.69% | 3 |
| truth_n6_0 | 6 | 188 | 124 | -34.04% | 3 |
| truth_n6_13 | 6 | 188 | 124 | -34.04% | 3 |
