...
| Submission support templates | pass | Cover letter, author declarations, upload checklist, reviewer-concern brief, and target-venue brief are present. | Fill the author-specific fields before journal upload. |
