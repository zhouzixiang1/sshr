...
| Payload round-trip integrity | pass | Payload round-trip audit exists; status_counts={'pass': 9}; needs_revision_count=0. | Rerun analyze_payload_roundtrip_audit.py after payload creation and fix any archive/manifest/path/hash issues. |
...
| Compiled PDF artifact | pass | Compiled PDF detected with 27 pages. | Run latexmk and visual spot checks after each table or figure change. |
