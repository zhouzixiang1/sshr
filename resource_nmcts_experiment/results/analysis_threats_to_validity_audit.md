...
| Weighted-score aggregation | pass | A single score could hide unfavorable CNOT, depth, ancilla, or lifetime behavior. | Raw dominance, schedule-proxy, weight-robustness, and counterpoint audits expose resource dimensions separately from the weighted score. | The method is presented as a strong T-count and weighted-score point, not complete raw-resource dominance. |
