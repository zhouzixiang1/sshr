...
Baseline: `adaptive Boolean screen n20` from `results/raw_giga_adaptive_screen_resource.csv` method `and_boolean_linear_pair_screen_adaptive`.
...
| time_s | 6 | 0 | 6 | 0 | 77.099 | 20.668 | +363.74% |
