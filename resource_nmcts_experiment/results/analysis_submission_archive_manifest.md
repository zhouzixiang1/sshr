...
| Scripts and docs | 67 | 0 | 1.2 MiB | `a115f4c52d8c3867` | Documents reproducible entry points; raw sweeps still require their individual drivers. |
...
| Submission support | 6 | 0 | 23.2 KiB | `c2f5bd24db9b8cf5` | Includes cover-letter, declaration, checklist, reviewer-brief, venue-selection, and structured metadata templates; author-specific fields remain manual. |
