...
| Scripts and docs | 67 | 0 | 1.2 MiB | `9f0c153063cbca09` | Documents reproducible entry points; raw sweeps still require their individual drivers. |
...
| Submission support | 7 | 0 | 27.7 KiB | `6882ec3de6190d0e` | Includes cover-letter, declaration, checklist, reviewer-brief, editor-screening, venue-selection, and structured metadata templates; author-specific fields remain manual. |
