...
|---|---:|---:|---:|---|---|
| Manuscript source | 3 | 0 | 71.6 KiB | `eaf7f90c8a236c3c` | Compiled PDF is checked by readiness audit to avoid self-referential hashes. |
...
| Derived summaries | 313 | 0 | 4.1 MiB | `391c6c5af4de0fef` | Terminal submission/package outputs are excluded so this manifest remains stable. |
| Run manifests | 67 | 0 | 91.5 KiB | `ca2b1f3044c3d1ce` | Submission-level terminal manifests are excluded from this digest group. |
| Scripts and docs | 67 | 0 | 1.2 MiB | `ffdaf1f1bbfd3b1c` | Documents reproducible entry points; raw sweeps still require their individual drivers. |
...
| Submission support | 5 | 0 | 17.9 KiB | `fc46d55fd53e3e77` | Includes cover-letter, declaration, checklist, reviewer-brief, and structured metadata templates; author-specific fields remain manual. |
