...
|---|---:|---:|---:|---|---|
| Manuscript source | 5 | 0 | 287.4 KiB | `fab13f6ee058305c` | Compiled PDF is checked by readiness audit to avoid self-referential hashes. |
...
| Derived summaries | 454 | 0 | 4.7 MiB | `1ad5b203688f6ab4` | Terminal submission/package outputs are excluded so this manifest remains stable. |
