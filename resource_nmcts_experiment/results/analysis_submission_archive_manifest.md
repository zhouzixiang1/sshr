...
|---|---:|---:|---:|---|---|
| Manuscript source | 3 | 0 | 70.9 KiB | `1d0cbb41ca17e7b2` | Compiled PDF is checked by readiness audit to avoid self-referential hashes. |
| Paper tables | 149 | 0 | 127.8 KiB | `4b5dc103ab67b9bd` | Terminal submission audit tables are excluded from the stable payload digest. |
...
| Derived summaries | 309 | 0 | 4.1 MiB | `22aa56c804cdd27b` | Terminal submission/package outputs are excluded so this manifest remains stable. |
| Run manifests | 65 | 0 | 73.2 KiB | `6a2272e4e76d727a` | Submission-level terminal manifests are excluded from this digest group. |
| Scripts and docs | 65 | 0 | 1.2 MiB | `50d9278c0a5e9415` | Documents reproducible entry points; raw sweeps still require their individual drivers. |
...
| Submission support | 4 | 0 | 12.6 KiB | `ddaf89e7f2a5dcfc` | Includes cover-letter, declaration, checklist, and reviewer-brief templates; author-specific fields remain manual. |
