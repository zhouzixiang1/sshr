...
|---|---:|---:|---:|---|---|
| Manuscript source | 4 | 0 | 125.7 KiB | `43f032f80cda327e` | Compiled PDF is checked by readiness audit to avoid self-referential hashes. |
| Paper tables | 157 | 0 | 145.3 KiB | `07859d16923795df` | Terminal submission audit tables are excluded from the stable payload digest. |
...
| Derived summaries | 347 | 0 | 4.3 MiB | `f8ac05d194d07f45` | Terminal submission/package outputs are excluded so this manifest remains stable. |
| Run manifests | 84 | 0 | 148.8 KiB | `233f7cc092439e8c` | Submission-level terminal manifests are excluded from this digest group. |
| Scripts and docs | 99 | 0 | 1.7 MiB | `b5df2d5e5eef99e3` | Documents reproducible entry points; raw sweeps still require their individual drivers. |
