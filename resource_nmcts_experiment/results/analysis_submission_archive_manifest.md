...
| Paper tables | 191 | 0 | 207.5 KiB | `8455e2317a22cd15` | Terminal submission audit tables are excluded from the stable payload digest. |
...
| Raw measurements | 160 | 0 | 98.1 MiB | `fd1bb6854f6d488e` | Raw CSVs are regenerated only by the heavier run scripts, not by the lightweight rebuild. |
| Derived summaries | 422 | 0 | 4.6 MiB | `e375b17d7fccc418` | Terminal submission/package outputs are excluded so this manifest remains stable. |
| Run manifests | 118 | 0 | 219.3 KiB | `4ceb3ec1dec76d1e` | Submission-level terminal manifests are excluded from this digest group. |
| Scripts and docs | 148 | 0 | 2.7 MiB | `3b0026cea721e688` | Includes reproducible entry points and top-level core implementation modules; raw sweeps still require their individual drivers. |
