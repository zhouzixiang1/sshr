...
|---|---:|---:|---:|---|---|
| Manuscript source | 5 | 0 | 241.9 KiB | `82f1f4f65a894693` | Compiled PDF is checked by readiness audit to avoid self-referential hashes. |
...
| Derived summaries | 408 | 0 | 4.5 MiB | `f09e0636092172bd` | Terminal submission/package outputs are excluded so this manifest remains stable. |
| Run manifests | 113 | 0 | 203.1 KiB | `158be6de0de77aa3` | Submission-level terminal manifests are excluded from this digest group. |
