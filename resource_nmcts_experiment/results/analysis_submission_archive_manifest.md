...
| Paper tables | 152 | 0 | 134.0 KiB | `f34fc949fa3b9adc` | Terminal submission audit tables are excluded from the stable payload digest. |
...
| Derived summaries | 337 | 0 | 4.3 MiB | `365d764e991ec97a` | Terminal submission/package outputs are excluded so this manifest remains stable. |
| Run manifests | 79 | 0 | 122.8 KiB | `98c2d0fe6140afcb` | Submission-level terminal manifests are excluded from this digest group. |
| Scripts and docs | 88 | 0 | 1.5 MiB | `13b189bbed42b9de` | Documents reproducible entry points; raw sweeps still require their individual drivers. |
...
| Submission support | 11 | 0 | 68.6 KiB | `bc1ce09b1d649fe2` | Includes public package README, author-input packet, artifact guide, cover-letter, declaration, checklist, reviewer-brief, editor-screening, venue-selection, and structured metadata templates; ignored generated private submission text is excluded. |
