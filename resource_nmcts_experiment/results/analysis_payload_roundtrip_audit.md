...
|---|---|---|---|
| Payload archive readable | pass | archive=submission_package/dist/resource_nmcts_submission_payload.tar.gz; members=1264; error=none. | Regenerate the payload archive if it cannot be opened by Python tarfile. |
| Payload manifest round-trip | pass | manifest_files=1264; archive_files=1264; missing=none; extra=none. | Regenerate make_submission_payload_archive.py outputs if manifest and archive contents diverge. |
| Payload per-file SHA256 | pass | checked=1264; mismatches=none. | Regenerate the payload archive and manifest if any archived file digest differs from the manifest. |
...
| Payload baseline fairness ledger | pass | comparison_fairness_files=5; missing=none. | Ensure the uploadable archive includes the baseline fairness ledger script, generated evidence, and manuscript table. |
| Payload comparison claim hierarchy | pass | comparison_claim_hierarchy_files=5; missing=none. | Ensure the uploadable archive includes the comparison claim hierarchy script, generated evidence, and manuscript table. |
| Payload experimental evidence ladder | pass | experimental_evidence_ladder_files=5; missing=none. | Ensure the uploadable archive includes the evidence-ladder script, generated evidence, and manuscript table. |
...
| Payload CNOT constraint profile evidence | pass | cnot_constraint_profile_files=7; missing=none. | Ensure the uploadable archive includes the CNOT-only rerun audit script, raw sweep, generated evidence, manifest, and manuscript table. |
| Payload SSHR reproduction-scope evidence | pass | sshr_reproduction_scope_files=31; missing=none. | Ensure the uploadable archive includes the SSHR reproduction-scope audit script, required raw rows, generated evidence, manifest, and manuscript table. |
...
| Payload learned-control evidence | pass | learned_control_files=59; missing=none. | Ensure the uploadable archive includes the learned-control audit script, generated evidence, manifest, and manuscript table. |
...
| Payload bit-flip learned-prior localization and gate evidence | pass | bitflip_prior_gate_files=20; missing=none. | Ensure the uploadable archive includes the learned-prior difficulty-slice and ANF-term feature-gate evidence. |
...
| Payload stochastic-control stability evidence | pass | stochastic_control_files=5; missing=none. | Ensure the uploadable archive includes the stochastic learned-control stability script, generated evidence, and manuscript table. |
...
| Payload citation support evidence | pass | citation_support_files=9; missing=none. | Ensure the uploadable archive includes the citation support audit script and generated CSV/Markdown/JSON evidence. |
| Payload oracle-resource citation evidence | pass | oracle_resource_citation_files=5; missing=none. | Ensure the uploadable archive includes the oracle-resource citation audit script, generated evidence, and manuscript table. |
...
| Payload minimal response-form coverage evidence | pass | author_minimal_form_files=5; missing=none. | Ensure the uploadable archive includes the minimal response-form coverage audit, generated evidence, and Chinese short intake form. |
...
| Payload deterministic tar metadata | pass | members_checked=1264; metadata_issues=none. | Keep tar member mtime/uid/gid/user/group/mode normalized for deterministic payloads. |
