...
def build_rows() -> list[dict[str, str]]:
    return [
        ...
        row(
            ...
            "Experimental Design, benchmark-suite audit, baseline matrices, target-validity table, comparison answer scorecard, SSHR reproduction-scope audit, and counterpoint audit",
