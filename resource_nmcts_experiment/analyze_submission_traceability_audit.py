...
def build_rows() -> list[dict[str, str]]:
    return [
        ...
        row(
            ...
            "Experimental Design, baseline matrices and counterpoint audit",
            "Treats comparisons as layered evidence and reports unfavorable metric counterpoints rather than a universal leaderboard.",
        ),
        row(
