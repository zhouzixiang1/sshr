...
- Machine snapshot tokens checked by `analyze_public_handoff_freshness_audit.py`:
  PDF pages=37/36; readiness=59 pass + 1 needs author input;
  payload_files=991; artifact_registry=24 families / 146 raw CSV / 60036 raw rows;
