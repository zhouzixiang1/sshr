...
```bash
./verify_submission_package.sh
rg -n "needs author input|needs revision|closure_path_ready" results/analysis_submission_readiness_audit.md results/analysis_editorial_screening_audit.md results/analysis_submission_metadata_audit.md results/analysis_submission_metadata_validator.md results/analysis_submission_metadata_closure_path.md
```
