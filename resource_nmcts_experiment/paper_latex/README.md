...
- external time-limited SSHR-I plus ABC-AIG/ABC-XAG/BDD/ABC-ESOP extension CSV:
  `../results/raw_external_traditional_resource_n6.csv`
- external time-limited SSHR-I plus ABC-AIG/ABC-XAG/BDD/ABC-ESOP extension analysis:
  `../results/analysis_external_traditional_resource_n6.md`
- external high-dimensional ABC-AIG/ABC-XAG/BDD CSV:
  `../results/raw_external_highdim_resource.csv`
- external high-dimensional ABC-AIG/ABC-XAG/BDD analysis:
  `../results/analysis_external_highdim_resource.md`
- external high-dimensional ABC-AIG/ABC-XAG/BDD scale CSV:
  `../results/raw_external_highdim_scale_resource.csv`
- external high-dimensional ABC-AIG/ABC-XAG/BDD scale analysis:
...
- add reproduced non-ABC/non-BDD high-dimensional external baselines where
