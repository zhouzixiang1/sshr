...
def build_items() -> list[GoalItem]:
    ...
    return [
        GoalItem(
            ...
            evidence="Related-work and contribution matrices position the method against BDD, LUT/ROS, XAG/MC, ABC/RevKit/mockturtle/CirKit, SSHR, and learning-guided synthesis.",
            evidence_files=(
                RESULTS / "analysis_related_work_positioning.md",
                RESULTS / "analysis_contribution_evidence_map.md",
                TABLES / "related_work_positioning.tex",
        ...
        GoalItem(
            ...
            boundary="Correctness is tied to ANF, emitted-circuit, truth-table, or phase checks; learned components only rank, gate, or allocate search.",
        ...
        GoalItem(
            ...
            evidence="Comparison evidence covers internal logical baselines, SSHR, ABC/BDD, ROS-style LUT, mockturtle, CirKit, RevKit CLI exact-oracle, and phase/Rz probes.",
            evidence_files=(
                RESULTS / "analysis_comparison_evidence_matrix.md",
                RESULTS / "analysis_baseline_comparability_audit.md",
                RESULTS / "raw_mockturtle_xag_probe.csv",
        ...
        GoalItem(
            ...
            status="pass" if figure_panels >= 7 and table_count >= 100 else "needs evidence",
            evidence=f"Current package has {figure_panels} submitted figure panels and {table_count} generated paper tables.",
            evidence_files=(FIGURES, TABLES, RESULTS / "analysis_reproducibility_audit.md"),
