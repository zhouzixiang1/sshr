...
def build_items() -> list[GoalItem]:
    ...
    return [
        ...
        GoalItem(
            ...
            evidence="Search-control, bit-flip random-prior, and learned-control audits separate heuristic/beam/no-MCTS/MCTS/Pareto/prior comparisons, same-budget random-prior controls, promoted frontier/gating/phase-pruning controls, and limited diagnostics.",
            evidence_files=(
                RESULTS / "analysis_search_control_baseline_audit.md",
                TABLES / "search_control_baseline_audit.tex",
                RESULTS / "analysis_bitflip_random_prior_control.md",
